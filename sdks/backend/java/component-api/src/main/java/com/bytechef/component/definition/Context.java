...
public interface Context {
    ...
    interface Http {
         ...
         *
         * @param connectTimeout the maximum duration to wait for the connection to be established
         * @return a {@link ConfigurationBuilder} initialized with the given setting
         */
        ...
        class Configuration {
            ...
            public static final class ConfigurationBuilder {
                 ...
                 *
                 * @param requestTimeout the maximum duration to wait for the request to complete
                 * @return this builder
                 */
