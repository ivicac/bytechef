...
- **[App Events](/openapi/backend/embedded-webhook-app-event-trigger)** - fire an App Event to start every one of a connected user's subscribed workflows.
- **[Request Trigger](/openapi/backend/embedded-webhook-request-trigger)** - execute a connected user's workflow synchronously and return its result.
