...
| maxToolCalls | Max Tool Calls | INTEGER | Maximum number of tool calls the agent may make in one run, across all tools. Leave empty for the default of 150. | false |
