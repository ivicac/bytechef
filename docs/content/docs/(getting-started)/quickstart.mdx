...
- **Your own infrastructure (Self-Hosted)**: Deploy and run ByteChef yourself. Supported on:
  ...
  - [Docker](/self-hosting/deployment/local-docker)
  - [Kubernetes](/self-hosting/deployment/kubernetes)
  - [AWS EC2](/self-hosting/deployment/aws-ec2)
  - [AWS ECS](/self-hosting/deployment/aws-ecs)
  - [Azure](/self-hosting/deployment/azure)
  - [Google Cloud](/self-hosting/deployment/google-cloud)
  - [DigitalOcean](/self-hosting/deployment/digitalocean)
...
{/* TODO screenshot: Create Project dialog — name and description fields with the Create button */}
...
- **Data pills**: Pull data between components using `${stepName.fieldName}` — see [Data Pills & Input Modes](/automation/build/data-pills)
