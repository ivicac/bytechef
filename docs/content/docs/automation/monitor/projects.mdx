...
{/* TODO screenshot: Workflow Executions page — the filter bar (project, workflow, status, date range) above the executions table */}
...
{/* TODO screenshot: failed execution detail — the task tree with the failed step highlighted and its input/output/error panel */}
