...
|---|---|---|
| **Integrations** (`/integrations`) | Letting an end user connect a third-party service via the ByteChef connect dialog. | `useConnectDialog` from [`@bytechef/embedded-react`](/embedded/quickstart#6-install-the-react-sdk) |
...
| Running a single component action | `front-end/src/app/api/action-kit/route.ts` |
