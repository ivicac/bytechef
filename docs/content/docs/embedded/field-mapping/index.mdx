...
{/* TODO screenshot: integration workflow editor — a Field Mapping input property being added to a step, showing the mapping rows (source field → destination field) */}
