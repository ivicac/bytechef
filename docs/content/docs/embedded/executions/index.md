...
In **Automations** mode, the execution detail sheet reuses the automation execution view and carries an [AI Copilot](/platform/copilot): it analyzes the finished or failed execution and helps debug errors. Copilot is an Enterprise Edition feature and is disabled by default _(the AI Copilot is coming soon — not yet available in the latest released version)_.
