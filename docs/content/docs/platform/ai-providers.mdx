...
{/* TODO screenshot: AI Providers page — the provider accordion list, each row with its icon, capability badges (Text / Image / Embeddings / Copilot), and an enable toggle, with the environment selector at the top */}
...
{/* TODO screenshot: an expanded provider row — the inline credentials form with the API Key input and Save button */}
...
- **Copilot** — the provider currently backing the Copilot documentation corpus.
