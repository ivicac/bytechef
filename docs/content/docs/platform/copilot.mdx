...
{/* TODO screenshot: workflow editor with the Copilot panel docked on the right — Ask/Build toggle and model picker at the top of the panel, a conversation in progress, sparkle button visible on the editor toolbar */}
...
| **Code workflow editor** | Ask and Build assistants scoped to a code-backed project or integration (see [Code Workflows](/enterprise/extensibility/code-workflows#copilot)) |
...
In the [embedded](/embedded) product, Copilot reaches parity with the automation editor: the **integration workflow editor** carries an integration-scoped Copilot panel, and the **workflow executions** sheet carries an execution-analysis Copilot — the same two surfaces documented above for automation.
