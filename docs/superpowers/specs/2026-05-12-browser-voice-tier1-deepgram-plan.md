> **Superseded (2026-09-08)** for the realtime half by [2026-09-08-voice-cluster-element-redesign-design.md](2026-09-08-voice-cluster-element-redesign-design.md): the voice agent is now a cluster element of the trigger and `websocketTasks` no longer exists.
