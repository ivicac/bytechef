import {ApiConnectorEndpointModel} from '@/middleware/platform/api-connector';

import ApiConnectorEndpointListItem from './ApiConnectorEndpointListItem';

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ApiConnectorEndpointList = ({
    apiConnectorEndpoints,
}: {
    apiConnectorEndpoints?: Array<ApiConnectorEndpointModel>;
}) => {
    return (
