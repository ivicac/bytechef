...
import {ApiCollectionEndpointModel, HttpMethodModel} from '@/middleware/automation/api-platform';
...
const formSchema = z.object({
    ...
    httpMethod: z.custom<HttpMethodModel>((value) => !!value),
    name: z.string().min(2, {
...
interface ApiEndpointDialogProps {
    ...
    apiEndpoint?: ApiCollectionEndpointModel;
    onClose?: () => void;
    projectId: number;
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Select onValueChange={field.onChange} value={apiEndpoint?.httpMethod}>
                                            ...
                                            <SelectContent>
                                                <SelectItem
                                                    key={HttpMethodModel.Get.toString()}
                                                    value={HttpMethodModel.Get.toString()}
                                                >
                                                    GET
                                                </SelectItem>

                                                <SelectItem
                                                    key={HttpMethodModel.Patch.toString()}
                                                    value={HttpMethodModel.Patch.toString()}
                                                >
                                                    PATCH
                                                </SelectItem>

                                                <SelectItem
                                                    key={HttpMethodModel.Post.toString()}
                                                    value={HttpMethodModel.Post.toString()}
                                                >
                                                    POST
                                                </SelectItem>

                                                <SelectItem
                                                    key={HttpMethodModel.Put.toString()}
                                                    value={HttpMethodModel.Put.toString()}
                                                >
                                                    PUT
                                                </SelectItem>

                                                <SelectItem
                                                    key={HttpMethodModel.Delete.toString()}
                                                    value={HttpMethodModel.Delete.toString()}
                                                >
                                                    DELETE
                                                </SelectItem>
                                            </SelectContent>
