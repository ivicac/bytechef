...
import {ApiCollectionEndpointModel} from '@/middleware/automation/api-platform';
...
import {ProjectInstanceWorkflowModel, WorkflowModel} from '@/shared/middleware/automation/configuration';
...
const ApiCollectionEndpointListItem = ({
    ...
    apiCollectionEndpoint: ApiCollectionEndpointModel;
    projectId: number;
