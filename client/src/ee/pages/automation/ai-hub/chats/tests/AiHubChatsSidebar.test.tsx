...
const {
    ...
    mockSharedChatsLoadingRef: {current: false},
...
vi.mock('@/ee/pages/automation/ai-hub/chats/hooks/useChats', () => ({
    ...
    useAiHubSharedChatsQuery: (...args: unknown[]) => {
        ...
        return {data: mockSharedChatsDataRef.current, isLoading: mockSharedChatsLoadingRef.current};
    },
...
describe('AiHubChatsSidebar "Shared with me" list', () => {
    ...
    it('renders no "Shared with me" section while the shared chats are still loading', () => {
        mockSharedChatsDataRef.current = undefined as unknown as AiHubChatI[];
        mockSharedChatsLoadingRef.current = true;
