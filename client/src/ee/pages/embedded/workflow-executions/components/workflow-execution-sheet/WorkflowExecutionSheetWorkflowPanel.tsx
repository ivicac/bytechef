                ...
                <ReactFlowProvider>
                    ...
                    >
                        {componentDefinitions && taskDispatcherDefinitions && workflow && (
                            ...
                            // the first-time chunk load suspends up to the nearest ancestor boundary (a route-level
                            // LazyLoadWrapper), blanking the whole page. Containing it here keeps the flash inside
                            // the panel.
                            <Suspense
                                fallback={
