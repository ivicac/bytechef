...
export class ApiCollectionTagApi extends runtime.BaseAPI {
     ...
     * Get API collection tags
     */
    async getApiCollectionTagsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TagModel>>> {
     ...
     * Get API collection tags
     */
    async getApiCollectionTags(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TagModel>> {
    ...
    async updateApiCollectionTagsRaw(requestParameters: UpdateApiCollectionTagsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['updateTagsRequestModel'] == null) {
            throw new runtime.RequiredError(
                'updateTagsRequestModel',
                'Required parameter "updateTagsRequestModel" was null or undefined when calling updateApiCollectionTags().'
            );
        }
