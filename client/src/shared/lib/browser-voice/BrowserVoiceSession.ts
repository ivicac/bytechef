 ...
 *   - adopt the server-assigned `sessionId`/`outputSampleRate` from the `connected` frame, and reconnect
 *     with a fresh token + `resumeSessionId` after an unexpected close
