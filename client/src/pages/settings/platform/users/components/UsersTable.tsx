        ...
        <Table>
            <TableHeader>
                <TableRow className="border-b-border/50">
                    ...
                    <TableHead className="sticky top-0 z-10 bg-surface-neutral-primary p-3 text-left text-xs font-medium tracking-wide text-content-neutral-secondary uppercase"></TableHead>
                </TableRow>
            </TableHeader>
