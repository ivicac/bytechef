...
import {CustomComponentModel} from '@/middleware/platform/custom-component';
...
interface CustomComponentItemProps {
    customComponent: CustomComponentModel;
}

const Title = ({customComponent}: {customComponent: CustomComponentModel}) => {
    return (
