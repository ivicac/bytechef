...
// Must live inside WorkflowTestChatRuntimeProvider (i.e. AssistantRuntimeProvider) so
// useComposerRuntime can access the nearest composer runtime context.
const WorkflowTestChatMicButton = () => {
...
const WorkflowTestChatPanel = () => {
    ...
    const composerActions = useMemo(() => {
        ...
        if (workflowSupportsVoice && !isVoiceOnlyWorkflow) {
            return (
                <>
                    <WorkflowTestChatMicButton />
        ...
        return <WorkflowTestChatMicButton />;
    }, [
