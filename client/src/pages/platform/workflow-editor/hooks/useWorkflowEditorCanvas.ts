...
const useWorkflowEditorCanvas = ({
    ...
    useEffect(() => {
        ...
        setViewport(
            {
                // The overlay panels pan the canvas horizontally to keep the graph clear of
                // themselves, so the first placement starts from that pan rather than from a bare 0,
                // which would slide the graph back under an open panel.
