...
import {useAiHubRetryableErrorStore} from '@/pages/automation/ai-hub/retry/stores/useAiHubRetryableErrorStore';
import {useThreadRuntime} from '@assistant-ui/react';
import {AlertTriangleIcon} from 'lucide-react';
import {useShallow} from 'zustand/react/shallow';

const AiHubRetryBanner = () => {
    const {clearError, currentError} = useAiHubRetryableErrorStore(
        useShallow((state) => ({
