import {filterAllowedFiles} from '@/pages/automation/ai-hub/composer/hooks/useAiHubAttachmentUpload';
...
const AiHubComposerDropZone = ({children, className, onFilesDropped}: AiHubComposerDropZonePropsI) => {
