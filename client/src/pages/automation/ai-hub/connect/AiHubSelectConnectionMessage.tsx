...
type ConnectionVisibilityType = 'ORGANIZATION' | 'PRIVATE' | 'PROJECT' | 'WORKSPACE';

const VISIBILITY_ORDER: Array<ConnectionVisibilityType> = ['PRIVATE', 'PROJECT', 'WORKSPACE', 'ORGANIZATION'];
 ...
 * for a given component. Companion to {@code AiHubCreateConnectionMessage}, which renders a "Connect &lt;X&gt;"
 ...
 * </p>
 */
const AiHubSelectConnectionMessage = ({data}: DataMessagePartProps<SelectConnectionDataI>) => {
...
export default AiHubSelectConnectionMessage;
