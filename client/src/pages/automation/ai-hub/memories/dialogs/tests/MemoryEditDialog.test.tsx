...
vi.mock('@/pages/automation/ai-hub/memories/hooks/useAiAutoMemories', () => ({
...
const {useUpdateAiAutoMemoryMutation} = await import('@/pages/automation/ai-hub/memories/hooks/useAiAutoMemories');
