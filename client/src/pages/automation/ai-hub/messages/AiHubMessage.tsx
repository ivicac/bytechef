...
import AiHubMessageContent from '@/pages/automation/ai-hub/messages/AiHubMessageContent';
...
const AiHubAssistantActionBar: FC = () => (
    <ActionBarPrimitive.Root
        ...
        className="aui-cc-assistant-action-bar mt-2 flex gap-1 text-muted-foreground data-floating:absolute data-floating:rounded-md data-floating:border data-floating:bg-background data-floating:p-1 data-floating:shadow-sm"
        hideWhenRunning
    >
...
const AiHubAssistantMessage: FC = () => (
    <MessagePrimitive.Root asChild>
        <div
            ...
            data-role="assistant"
        >
            <div className="mx-2 text-sm leading-7 break-words text-foreground">
                <AiHubMessageContent />
            </div>
