                    ...
                    <Tabs defaultValue="overview">
                        ...
                        and the form would lose its visual identity as a focused settings surface. */}
                            ...
                            <fieldset className="mx-auto flex w-full max-w-2xl flex-col gap-5 border-0">
                                ...
                                {/*
                                 * Per-agent LLM override — uses the shared {@link ModelPicker} (also used in Copilot + AI Hub
                                 * chat panels). The picker reads the workspace's enabled AI Gateway providers + models from
                                 * the same GraphQL queries the old two-Select setup used; the visible affordance is a single
                                 * cascading dropdown instead of two side-by-side selects. The "Use workspace default" sentinel
                                 * maps to (null, null) → empty strings on save, preserving the existing wire format.
                                 */}
                                ...
                                <fieldset className="flex flex-col gap-2 border-0">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Override the workspace default LLM for this agent. Pick &quot;Use workspace
                                        default&quot; to revert.
                                    </p>
                                </fieldset>
