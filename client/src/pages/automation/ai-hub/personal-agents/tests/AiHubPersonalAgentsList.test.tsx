...
vi.mock('@/pages/automation/ai-hub/personal-agents/hooks/useAiHubPersonalAgents', () => ({
...
vi.mock('@/pages/automation/ai-hub/tasks/stores/useAiHubTasksStore', () => ({
    aiHubTasksStore: {
        getState: () => ({
...
vi.mock('@/pages/automation/ai-hub/stores/useAiHubStore', () => ({
    aiHubStore: {setState: setStateMock},
}));

const {useAiHubPersonalAgentsQuery} =
    await import('@/pages/automation/ai-hub/personal-agents/hooks/useAiHubPersonalAgents');
