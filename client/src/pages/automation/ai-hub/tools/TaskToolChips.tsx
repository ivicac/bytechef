...
import useTaskToolsCache from '@/pages/automation/ai-hub/tools/hooks/useTaskToolsCache';
...
const TaskToolChips = ({taskId, workspaceId}: TaskToolChipsPropsI) => {
    ...
    return (
        <div className="flex flex-wrap gap-1.5 px-3 pt-2" data-testid="task-tool-chips">
            {tools.map((tool) => (
                <Badge
                    className="flex items-center gap-1 bg-orange-100 px-2 py-0.5 text-xs font-normal text-orange-700"
