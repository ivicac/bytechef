 ...
 * as its own {@code AiAgentChannel}/{@code AiAgentElement} row via the dedicated sections below. Kept apart from
 * the routed project agent page ({@code ProjectAgent.tsx}) so the AI Hub resource-panel tab
