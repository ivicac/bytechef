...
const config: CodegenConfig = {
    ...
    schema: [
        ...
        '../server/ee/libs/automation/automation-promotion/automation-promotion-graphql/src/main/resources/graphql/*.graphqls',
        ...
        '../server/ee/libs/platform/platform-tool-invocation-log/platform-tool-invocation-log-graphql/src/main/resources/graphql/*.graphqls',
        '../server/libs/platform/platform-oauth2-authorization-server/src/main/resources/graphql/*.graphqls',
        ...
        '../server/ee/libs/ai/ai-hub/ai-hub-graphql/src/main/resources/graphql/*.graphqls',
        ...
        '../server/ee/libs/platform/platform-ai/platform-ai-guardrails/platform-ai-guardrails-graphql/src/main/resources/graphql/*.graphqls',
        ...
        '../server/ee/libs/platform/platform-variable/platform-variable-graphql/src/main/resources/graphql/*.graphqls',
