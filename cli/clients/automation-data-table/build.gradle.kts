...
val generateClient by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    library.set("native")
    inputSpec.set("${rootDir}/server/ee/libs/automation/automation-data-table/automation-data-table-public-rest/openapi.yaml")
    outputDir.set("$projectDir/generated")
    apiPackage.set("com.bytechef.cli.client.automationdatatable.api")
    modelPackage.set("com.bytechef.cli.client.automationdatatable.model")
    invokerPackage.set("com.bytechef.cli.client.automationdatatable")
