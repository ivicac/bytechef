 ...
 */
@JsonPropertyOrder({
  ClearRowsResponseModel.JSON_PROPERTY_DELETED_COUNT
})
...
public class ClearRowsResponseModel {
  ...
  public ClearRowsResponseModel() { 
  }

  public ClearRowsResponseModel deletedCount(@jakarta.annotation.Nullable Long deletedCount) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DELETED_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeletedCount(@jakarta.annotation.Nullable Long deletedCount) {
    this.deletedCount = deletedCount;
  }


  /**
   * Return true if this ClearRowsResponse object is equal to o.
   */
  @Override
