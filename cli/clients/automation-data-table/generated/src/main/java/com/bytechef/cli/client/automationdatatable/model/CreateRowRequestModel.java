 ...
 */
@JsonPropertyOrder({
  CreateRowRequestModel.JSON_PROPERTY_VALUES,
  CreateRowRequestModel.JSON_PROPERTY_EXTERNAL_ID
})
...
public class CreateRowRequestModel {
  ...
  public CreateRowRequestModel values(@jakarta.annotation.Nonnull Map<String, Object> values) {
    this.values = values;
    return this;
  }
  ...
  public CreateRowRequestModel externalId(@jakarta.annotation.Nullable String externalId) {
  ...
  /**
   * Return true if this CreateRowRequest object is equal to o.
   */
  @Override
