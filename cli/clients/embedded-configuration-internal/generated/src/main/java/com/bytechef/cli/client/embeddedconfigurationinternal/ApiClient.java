...
package com.bytechef.cli.client.embeddedconfigurationinternal;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    updateBaseUri("/api/embedded/internal");
    interceptor = null;
    readTimeout = null;
    connectTimeout = null;
  ...
  public ApiClient(HttpClient.Builder builder, ObjectMapper mapper, String baseUri) {
    ...
    this.mapper = mapper;
    updateBaseUri(baseUri != null ? baseUri : "/api/embedded/internal");
    interceptor = null;
    readTimeout = null;
    connectTimeout = null;
    responseInterceptor = null;
