...
include("spring-ai:spring-ag-ui:packages:core")
include("spring-ai:spring-ag-ui:utils:json")
include("spring-ai:spring-ag-ui:packages:server")
include("spring-ai:spring-ag-ui:servers:spring")
include("spring-ai:spring-ag-ui:integrations:spring-ai")
...
include("server:libs:ai:ai-copilot:ai-copilot-api")
include("server:libs:ai:ai-copilot:ai-copilot-service")
include("server:libs:ai:ai-copilot:ai-copilot-tool")
...
include("server:libs:automation:automation-ai:automation-ai-mcp-server-api")
include("server:libs:automation:automation-ai:automation-ai-tool")
include("server:libs:automation:automation-configuration:automation-configuration-api")
include("server:libs:automation:automation-configuration:automation-configuration-graphql")
...
include("server:libs:automation:automation-knowledge-base:automation-knowledge-base-api")
include("server:libs:automation:automation-knowledge-base:automation-knowledge-base-graphql")
include("server:libs:automation:automation-knowledge-base:automation-knowledge-base-service")
include("server:libs:automation:automation-search:automation-search-api")
include("server:libs:automation:automation-search:automation-search-graphql")
include("server:libs:automation:automation-search:automation-search-service")
include("server:libs:automation:automation-task:automation-task-api")
include("server:libs:automation:automation-task:automation-task-graphql")
include("server:libs:automation:automation-task:automation-task-service")
...
include("server:libs:config:ai-model-config")
...
include("server:libs:config:eval-config")
...
include("server:libs:config:pgvector-config")
...
include("server:libs:core:graphql:graphql-api")
include("server:libs:core:graphql:graphql-impl")
...
include("server:libs:core:message:message-broker:message-broker-memory")
...
include("server:libs:platform:platform-ai:platform-ai-skill:platform-ai-skill-graphql")
...
include("server:libs:platform:platform-billing:platform-billing-api")
include("server:libs:platform:platform-billing:platform-billing-rest")
include("server:libs:platform:platform-billing:platform-billing-service")
...
include("server:libs:platform:platform-configuration:platform-configuration-graphql")
...
include("server:libs:platform:platform-data-table:platform-data-table-api")
include("server:libs:platform:platform-data-table:platform-data-table-service")
...
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-api")
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-file-storage:platform-knowledge-base-file-storage-api")
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-file-storage:platform-knowledge-base-file-storage-impl")
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-rest")
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-service")
include("server:libs:platform:platform-knowledge-base:platform-knowledge-base-worker")
include("server:libs:platform:platform-mcp:platform-mcp-api")
include("server:libs:platform:platform-mcp:platform-mcp-graphql")
include("server:libs:platform:platform-mcp:platform-mcp-server-support")
...
include("server:libs:platform:platform-user:platform-user-graphql")
...
include("server:libs:platform:platform-webhook:platform-websocket-webhook-rest")
...
include("server:libs:modules:components:action-network")
include("server:libs:modules:components:active-campaign")
include("server:libs:modules:components:acuity-scheduling")
...
include("server:libs:modules:components:agencyzoom")
...
include("server:libs:modules:components:ai:agent:chat-memory:chat-memory-builtin")
include("server:libs:modules:components:ai:agent:chat-memory:chat-memory-cassandra")
...
include("server:libs:modules:components:ai:agent:guardrails:check-for-violations")
include("server:libs:modules:components:ai:agent:guardrails:sanitize-text")
include("server:libs:modules:components:ai:agent:guardrails:jailbreak")
include("server:libs:modules:components:ai:agent:guardrails:nsfw")
include("server:libs:modules:components:ai:agent:guardrails:topical-alignment")
include("server:libs:modules:components:ai:agent:guardrails:custom")
include("server:libs:modules:components:ai:agent:guardrails:keywords")
include("server:libs:modules:components:ai:agent:guardrails:llm-pii")
include("server:libs:modules:components:ai:agent:guardrails:pii")
include("server:libs:modules:components:ai:agent:guardrails:secret-keys")
include("server:libs:modules:components:ai:agent:guardrails:urls")
include("server:libs:modules:components:ai:agent:guardrails:custom-regex")
...
include("server:libs:modules:components:ai:llm:gemini")
...
include("server:libs:modules:components:ai:llm:router")
include("server:libs:modules:components:ai:llm:router:litellm")
include("server:libs:modules:components:ai:llm:router:nano-gpt")
include("server:libs:modules:components:ai:llm:router:open-router")
...
include("server:libs:modules:components:ai:vectorstore:knowledgebase")
include("server:libs:modules:components:ai:vectorstore:mariaDB")
include("server:libs:modules:components:ai:vectorstore:milvus")
include("server:libs:modules:components:ai:vectorstore:mongodb-atlas")
include("server:libs:modules:components:ai:vectorstore:neo4j")
include("server:libs:modules:components:ai:vectorstore:oracle")
include("server:libs:modules:components:ai:vectorstore:pgvector")
...
include("server:libs:modules:components:ai:vectorstore:s3")
...
include("server:libs:modules:components:aircall")
include("server:libs:modules:components:airtable")
include("server:libs:modules:components:airtop")
include("server:libs:modules:components:aitable")
include("server:libs:modules:components:algolia")
include("server:libs:modules:components:amplitude")
include("server:libs:modules:components:apaleo")
include("server:libs:modules:components:apify")
include("server:libs:modules:components:apitemplate-io")
include("server:libs:modules:components:apollo")
include("server:libs:modules:components:approval")
include("server:libs:modules:components:approval-link")
include("server:libs:modules:components:approval-task")
include("server:libs:modules:components:asana")
include("server:libs:modules:components:ashby")
include("server:libs:modules:components:assemblyai")
include("server:libs:modules:components:attio")
include("server:libs:modules:components:avian")
include("server:libs:modules:components:aws:aws-lambda")
include("server:libs:modules:components:aws:aws-s3")
include("server:libs:modules:components:aws:aws-ses")
include("server:libs:modules:components:aws:aws-sqs")
include("server:libs:modules:components:aws:aws-textract")
include("server:libs:modules:components:aws:aws-transcribe")
include("server:libs:modules:components:azure-blob-storage")
include("server:libs:modules:components:azure-devops")
include("server:libs:modules:components:backblaze")
include("server:libs:modules:components:bamboohr")
include("server:libs:modules:components:bannerbear")
...
include("server:libs:modules:components:bigcommerce")
include("server:libs:modules:components:binance")
include("server:libs:modules:components:bitbucket")
include("server:libs:modules:components:bitly")
include("server:libs:modules:components:bitwarden")
include("server:libs:modules:components:blackboard")
include("server:libs:modules:components:bluesky")
include("server:libs:modules:components:bocha-search")
include("server:libs:modules:components:bolna")
include("server:libs:modules:components:box")
include("server:libs:modules:components:brandfetch")
include("server:libs:modules:components:brave")
include("server:libs:modules:components:breakcold")
include("server:libs:modules:components:brevo")
include("server:libs:modules:components:brightspace")
include("server:libs:modules:components:browser-use")
include("server:libs:modules:components:browserbase")
include("server:libs:modules:components:bubble")
include("server:libs:modules:components:buffer")
include("server:libs:modules:components:calcom")
include("server:libs:modules:components:calendly")
include("server:libs:modules:components:campaign-monitor")
include("server:libs:modules:components:canva")
include("server:libs:modules:components:canvas")
include("server:libs:modules:components:capsule-crm")
include("server:libs:modules:components:carbone")
include("server:libs:modules:components:chargebee")
include("server:libs:modules:components:chat")
include("server:libs:modules:components:chatwoot")
include("server:libs:modules:components:circleci")
include("server:libs:modules:components:claude-code")
include("server:libs:modules:components:ai:agent:utils")
include("server:libs:modules:components:clay")
include("server:libs:modules:components:clickup")
include("server:libs:modules:components:clickhouse")
include("server:libs:modules:components:clockify")
include("server:libs:modules:components:close")
include("server:libs:modules:components:cloudconvert")
include("server:libs:modules:components:cloudflare")
include("server:libs:modules:components:coda")
include("server:libs:modules:components:cognito-forms")
include("server:libs:modules:components:cohere")
include("server:libs:modules:components:coinbase")
include("server:libs:modules:components:coingecko")
include("server:libs:modules:components:confluence")
include("server:libs:modules:components:constant-contact")
include("server:libs:modules:components:contentful")
include("server:libs:modules:components:contiguity")
include("server:libs:modules:components:convertkit")
include("server:libs:modules:components:copper")
include("server:libs:modules:components:cratedb")
include("server:libs:modules:components:crisp")
include("server:libs:modules:components:crypto-helper")
include("server:libs:modules:components:csv-file")
include("server:libs:modules:components:cursor")
include("server:libs:modules:components:customer-io")
...
include("server:libs:modules:components:data-stream:data-stream-processor")
include("server:libs:modules:components:data-table")
include("server:libs:modules:components:dagster")
include("server:libs:modules:components:databricks")
include("server:libs:modules:components:datadog")
include("server:libs:modules:components:date-helper")
include("server:libs:modules:components:deepgram")
include("server:libs:modules:components:deepl")
include("server:libs:modules:components:wait")
include("server:libs:modules:components:descript")
include("server:libs:modules:components:devin")
include("server:libs:modules:components:devto")
include("server:libs:modules:components:dhl")
include("server:libs:modules:components:discord")
include("server:libs:modules:components:discourse")
include("server:libs:modules:components:docusign")
include("server:libs:modules:components:drift")
include("server:libs:modules:components:dropbox")
include("server:libs:modules:components:dropcontact")
include("server:libs:modules:components:dub")
include("server:libs:modules:components:elastic-email")
include("server:libs:modules:components:elasticsearch")
include("server:libs:modules:components:elevenlabs")
include("server:libs:modules:components:email")
include("server:libs:modules:components:email-octopus")
include("server:libs:modules:components:encharge")
include("server:libs:modules:components:erpnext")
include("server:libs:modules:components:esignatures")
include("server:libs:modules:components:exa")
include("server:libs:modules:components:example")
include("server:libs:modules:components:facebook-pages")
include("server:libs:modules:components:fathom")
include("server:libs:modules:components:fathom-analytics")
include("server:libs:modules:components:figma")
include("server:libs:modules:components:file-helper")
include("server:libs:modules:components:file-storage")
include("server:libs:modules:components:filemaker")
include("server:libs:modules:components:filesystem")
include("server:libs:modules:components:fillout")
include("server:libs:modules:components:firecrawl")
include("server:libs:modules:components:fireflies")
include("server:libs:modules:components:flowise")
include("server:libs:modules:components:folk")
include("server:libs:modules:components:form")
include("server:libs:modules:components:formbricks")
include("server:libs:modules:components:formstack")
include("server:libs:modules:components:foursquare")
include("server:libs:modules:components:freshdesk")
include("server:libs:modules:components:freshsales")
include("server:libs:modules:components:freshservice")
include("server:libs:modules:components:freshworks-crm")
include("server:libs:modules:components:front")
include("server:libs:modules:components:ftp")
include("server:libs:modules:components:gamma")
include("server:libs:modules:components:gaurus")
include("server:libs:modules:components:getresponse")
include("server:libs:modules:components:ghost")
include("server:libs:modules:components:gladia")
include("server:libs:modules:components:gitea")
include("server:libs:modules:components:github")
include("server:libs:modules:components:gitlab")
include("server:libs:modules:components:gong")
include("server:libs:modules:components:google:google-ads")
include("server:libs:modules:components:google:google-analytics")
...
include("server:libs:modules:components:google:google-cloud-storage")
...
include("server:libs:modules:components:google:google-firestore")
...
include("server:libs:modules:components:google:google-my-business")
include("server:libs:modules:components:google:google-photos")
include("server:libs:modules:components:google:google-realtime-database")
include("server:libs:modules:components:google:google-search-console")
...
include("server:libs:modules:components:google:google-translate")
include("server:libs:modules:components:google:google-workspace-admin")
include("server:libs:modules:components:google:youtube")
include("server:libs:modules:components:gorgias")
include("server:libs:modules:components:gotify")
include("server:libs:modules:components:grafana")
include("server:libs:modules:components:granola")
include("server:libs:modules:components:graphql-client")
include("server:libs:modules:components:gravity-forms")
include("server:libs:modules:components:greenhouse")
include("server:libs:modules:components:grist")
include("server:libs:modules:components:hacker-news")
include("server:libs:modules:components:harvest")
include("server:libs:modules:components:help-scout")
include("server:libs:modules:components:heygen")
include("server:libs:modules:components:highlevel")
include("server:libs:modules:components:home-assistant")
include("server:libs:modules:components:http-client")
include("server:libs:modules:components:hootsuite")
include("server:libs:modules:components:hubspot")
include("server:libs:modules:components:hunter")
include("server:libs:modules:components:hugging-face")
include("server:libs:modules:components:icypeas")
include("server:libs:modules:components:image-helper")
include("server:libs:modules:components:incident-io")
include("server:libs:modules:components:infisical")
include("server:libs:modules:components:infobip")
include("server:libs:modules:components:insightly")
include("server:libs:modules:components:instagram-business")
include("server:libs:modules:components:intercom")
include("server:libs:modules:components:invoice-ninja")
include("server:libs:modules:components:jenkins")
include("server:libs:modules:components:jina")
include("server:libs:modules:components:jira")
include("server:libs:modules:components:jotform")
include("server:libs:modules:components:jungle-scout")
...
include("server:libs:modules:components:kommo")
include("server:libs:modules:components:kustomer")
include("server:libs:modules:components:launchdarkly")
include("server:libs:modules:components:ldap")
include("server:libs:modules:components:leadmagic")
include("server:libs:modules:components:lemlist")
include("server:libs:modules:components:lemon-squeezy")
include("server:libs:modules:components:letta")
include("server:libs:modules:components:lever")
include("server:libs:modules:components:liferay")
include("server:libs:modules:components:line")
include("server:libs:modules:components:linear")
include("server:libs:modules:components:linkedin")
include("server:libs:modules:components:linkup")
include("server:libs:modules:components:list-helper")
include("server:libs:modules:components:listen-notes")
include("server:libs:modules:components:lmnt")
include("server:libs:modules:components:logger")
include("server:libs:modules:components:loops")
include("server:libs:modules:components:mailcheck")
include("server:libs:modules:components:magento")
include("server:libs:modules:components:mailchimp")
include("server:libs:modules:components:mailerlite")
include("server:libs:modules:components:mailgun")
include("server:libs:modules:components:mailjet")
include("server:libs:modules:components:mandrill")
include("server:libs:modules:components:manychat")
include("server:libs:modules:components:map")
include("server:libs:modules:components:mastodon")
include("server:libs:modules:components:math-helper")
include("server:libs:modules:components:matomo")
include("server:libs:modules:components:matrix")
include("server:libs:modules:components:mattermost")
include("server:libs:modules:components:mautic")
include("server:libs:modules:components:meistertask")
include("server:libs:modules:components:mem")
include("server:libs:modules:components:mem0")
include("server:libs:modules:components:merge-helper")
include("server:libs:modules:components:messagebird")
include("server:libs:modules:components:metabase")
include("server:libs:modules:components:mcp-client")
include("server:libs:modules:components:microsoft:microsoft-clarity")
include("server:libs:modules:components:microsoft:microsoft-commons")
include("server:libs:modules:components:microsoft:microsoft-dataverse")
include("server:libs:modules:components:microsoft:microsoft-dynamics-crm")
...
include("server:libs:modules:components:microsoft:microsoft-one-note")
include("server:libs:modules:components:microsoft:microsoft-outlook-365")
include("server:libs:modules:components:microsoft:microsoft-planner")
include("server:libs:modules:components:microsoft:microsoft-power-bi")
include("server:libs:modules:components:microsoft:microsoft-share-point")
include("server:libs:modules:components:microsoft:microsoft-sql-server")
...
include("server:libs:modules:components:millionverifier")
include("server:libs:modules:components:mindee")
include("server:libs:modules:components:missive")
include("server:libs:modules:components:mistral-ai")
include("server:libs:modules:components:mixpanel")
include("server:libs:modules:components:mollie")
include("server:libs:modules:components:monday")
include("server:libs:modules:components:mongodb")
include("server:libs:modules:components:motion")
include("server:libs:modules:components:myob")
include("server:libs:modules:components:mysql")
include("server:libs:modules:components:nasa")
include("server:libs:modules:components:neo4j")
include("server:libs:modules:components:neon")
include("server:libs:modules:components:netlify")
include("server:libs:modules:components:neverbounce")
include("server:libs:modules:components:new-relic")
include("server:libs:modules:components:nextcloud")
include("server:libs:modules:components:nifty")
include("server:libs:modules:components:nocobase")
...
include("server:libs:modules:components:obsidian")
include("server:libs:modules:components:ods-file")
include("server:libs:modules:components:odoo")
include("server:libs:modules:components:okta")
include("server:libs:modules:components:omnisend")
include("server:libs:modules:components:one-simple-api")
include("server:libs:modules:components:onfleet")
include("server:libs:modules:components:openweather")
include("server:libs:modules:components:onepagecrm")
include("server:libs:modules:components:onepassword")
include("server:libs:modules:components:oracle:oracle-fusion")
include("server:libs:modules:components:oracle:oracle-sql")
include("server:libs:modules:components:paddle")
include("server:libs:modules:components:pagerduty")
include("server:libs:modules:components:pandadoc")
include("server:libs:modules:components:paperform")
include("server:libs:modules:components:paypal")
include("server:libs:modules:components:pdf-co")
include("server:libs:modules:components:pdf-helper")
include("server:libs:modules:components:pdf4me")
include("server:libs:modules:components:pdfmonkey")
include("server:libs:modules:components:peopledatalabs")
include("server:libs:modules:components:perplexity")
include("server:libs:modules:components:petstore")
include("server:libs:modules:components:phantombuster")
include("server:libs:modules:components:phone-number-helper")
include("server:libs:modules:components:pinecone")
include("server:libs:modules:components:pinterest")
include("server:libs:modules:components:pipedrive")
include("server:libs:modules:components:pipeliner")
include("server:libs:modules:components:plausible")
include("server:libs:modules:components:plivo")
include("server:libs:modules:components:postgresql")
include("server:libs:modules:components:posthog")
include("server:libs:modules:components:postiz")
include("server:libs:modules:components:postmark")
include("server:libs:modules:components:productboard")
include("server:libs:modules:components:property-testing")
include("server:libs:modules:components:pubrio")
include("server:libs:modules:components:pushover")
include("server:libs:modules:components:pushbullet")
include("server:libs:modules:components:pylon")
include("server:libs:modules:components:qdrant")
include("server:libs:modules:components:quaderno")
include("server:libs:modules:components:questdb")
include("server:libs:modules:components:quickbase")
include("server:libs:modules:components:quickchart")
include("server:libs:modules:components:quickbooks")
include("server:libs:modules:components:rabbitmq")
include("server:libs:modules:components:railway")
include("server:libs:modules:components:raindrop")
include("server:libs:modules:components:random-helper")
include("server:libs:modules:components:razorpay")
include("server:libs:modules:components:recall-ai")
include("server:libs:modules:components:reckon")
include("server:libs:modules:components:recurly")
include("server:libs:modules:components:redis")
include("server:libs:modules:components:reddit")
include("server:libs:modules:components:reoon-verifier")
include("server:libs:modules:components:resend")
include("server:libs:modules:components:retable")
include("server:libs:modules:components:retell-ai")
include("server:libs:modules:components:rippling")
include("server:libs:modules:components:rocketchat")
include("server:libs:modules:components:rocketlane")
include("server:libs:modules:components:rootly")
include("server:libs:modules:components:rss")
include("server:libs:modules:components:rundeck")
include("server:libs:modules:components:runway")
include("server:libs:modules:components:salesflare")
include("server:libs:modules:components:salesforce")
include("server:libs:modules:components:salesloft")
include("server:libs:modules:components:schedule")
include("server:libs:modules:components:scrape-graph-ai")
include("server:libs:modules:components:scrapeunblocker")
include("server:libs:modules:components:script")
include("server:libs:modules:components:segment")
include("server:libs:modules:components:semantic-scholar")
include("server:libs:modules:components:sendfox")
include("server:libs:modules:components:sendgrid")
include("server:libs:modules:components:sendpulse")
include("server:libs:modules:components:sendy")
include("server:libs:modules:components:sentry")
include("server:libs:modules:components:serpapi")
include("server:libs:modules:components:servicenow")
include("server:libs:modules:components:shopify")
include("server:libs:modules:components:shortcut")
include("server:libs:modules:components:signnow")
include("server:libs:modules:components:signrequest")
include("server:libs:modules:components:sixtyfour")
include("server:libs:modules:components:slack")
include("server:libs:modules:components:smartsheet")
include("server:libs:modules:components:smartsuite")
include("server:libs:modules:components:snowflake")
include("server:libs:modules:components:splunk")
include("server:libs:modules:components:spotify")
include("server:libs:modules:components:square")
include("server:libs:modules:components:streak")
include("server:libs:modules:components:stripe")
include("server:libs:modules:components:sugarcrm")
include("server:libs:modules:components:supabase")
include("server:libs:modules:components:surveymonkey")
include("server:libs:modules:components:synthesia")
include("server:libs:modules:components:tailscale")
include("server:libs:modules:components:tally")
include("server:libs:modules:components:tapfiliate")
include("server:libs:modules:components:taskade")
include("server:libs:modules:components:tavily")
include("server:libs:modules:components:teable")
include("server:libs:modules:components:teamleader")
include("server:libs:modules:components:teamwork")
include("server:libs:modules:components:telegram")
include("server:libs:modules:components:telnyx")
include("server:libs:modules:components:temporal")
include("server:libs:modules:components:text-helper")
include("server:libs:modules:components:ticktick")
include("server:libs:modules:components:tiktok")
include("server:libs:modules:components:todoist")
include("server:libs:modules:components:totp-helper")
include("server:libs:modules:components:trello")
include("server:libs:modules:components:triggerdev")
include("server:libs:modules:components:twilio")
include("server:libs:modules:components:twenty")
include("server:libs:modules:components:twitch")
include("server:libs:modules:components:typeform")
include("server:libs:modules:components:typefully")
include("server:libs:modules:components:umami")
include("server:libs:modules:components:uptimerobot")
include("server:libs:modules:components:urlscan")
include("server:libs:modules:components:vapi")
include("server:libs:modules:components:upstash")
include("server:libs:modules:components:var")
include("server:libs:modules:components:vbout")
include("server:libs:modules:components:vercel")
include("server:libs:modules:components:vero")
include("server:libs:modules:components:vimeo")
include("server:libs:modules:components:vonage")
include("server:libs:modules:components:vtiger")
include("server:libs:modules:components:wealthbox")
include("server:libs:modules:components:webex")
...
include("server:libs:modules:components:wikipedia")
include("server:libs:modules:components:wise")
...
include("server:libs:modules:components:workable")
include("server:libs:modules:components:workday")
include("server:libs:modules:components:wrike")
include("server:libs:modules:components:x")
include("server:libs:modules:components:wufoo")
...
include("server:libs:modules:components:youcom")
include("server:libs:modules:components:youtrack")
include("server:libs:modules:components:zendesk")
include("server:libs:modules:components:zendesk-sell")
include("server:libs:modules:components:zerobounce")
include("server:libs:modules:components:zenrows")
include("server:libs:modules:components:zep")
include("server:libs:modules:components:zeplin")
include("server:libs:modules:components:zip-helper")
include("server:libs:modules:components:zoho:zoho-bigin")
...
include("server:libs:modules:components:zuora")
...
include("sdks:backend:embedded:ai-componentkit")
include("sdks:backend:embedded:ai-componentkit-spring")
...
include("server:ee:libs:config:security-sso-config")
...
include("server:ee:libs:embedded:embedded-ai:embedded-ai-mcp-service")
include("server:ee:libs:embedded:embedded-configuration:embedded-configuration-api")
include("server:ee:libs:embedded:embedded-configuration:embedded-configuration-graphql")
...
include("server:ee:libs:embedded:embedded-webhook:embedded-webhook-public-rest")
...
include("server:ee:libs:platform:platform-user:platform-user-api")
include("server:ee:libs:platform:platform-user:platform-user-remote-client")
include("server:ee:libs:platform:platform-user:platform-user-graphql")
include("server:ee:libs:platform:platform-user:platform-user-scim")
include("server:ee:libs:platform:platform-user:platform-user-service")
...
include("server:ee:libs:platform:platform-configuration:platform-configuration-graphql")
