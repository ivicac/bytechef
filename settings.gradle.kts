...
include("server:libs:core:class-loader-api")
...
include("server:libs:embedded:embedded-unified:embedded-unified-rest")
...
include("server:libs:platform:platform-code-workflow:platform-code-workflow-configuration:platform-code-workflow-configuration-api")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-configuration:platform-code-workflow-configuration-automation:platform-code-workflow-configuration-automation-api")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-configuration:platform-code-workflow-configuration-automation:platform-code-workflow-configuration-automation-public-rest")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-configuration:platform-code-workflow-configuration-automation:platform-code-workflow-configuration-automation-service")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-configuration:platform-code-workflow-configuration-service")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-file-storage:platform-code-workflow-file-storage-api")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-file-storage:platform-code-workflow-file-storage-impl")
include("server:libs:platform:platform-code-workflow:platform-code-workflow-loader:platform-code-workflow-loader-automation")
include("server:libs:platform:platform-custom-component:platform-custom-component-configuration:platform-custom-component-configuration-api")
include("server:libs:platform:platform-custom-component:platform-custom-component-configuration:platform-custom-component-configuration-public-rest")
include("server:libs:platform:platform-custom-component:platform-custom-component-configuration:platform-custom-component-configuration-rest")
include("server:libs:platform:platform-custom-component:platform-custom-component-configuration:platform-custom-component-configuration-service")
include("server:libs:platform:platform-custom-component:platform-custom-component-file-storage:platform-custom-component-file-storage-api")
include("server:libs:platform:platform-custom-component:platform-custom-component-file-storage:platform-custom-component-file-storage-impl")
include("server:libs:platform:platform-custom-component:platform-custom-component-handler")
include("server:libs:platform:platform-custom-component:platform-custom-component-loader")
...
include("server:libs:platform:platform-data-sync:platform-data-sync-configuration:platform-data-sync-configuration-api")
include("server:libs:platform:platform-data-sync:platform-data-sync-configuration:platform-data-sync-configuration-rest")
include("server:libs:platform:platform-data-sync:platform-data-sync-configuration:platform-data-sync-configuration-service")
...
include("server:libs:modules:components:api-platform")
...
include("server:libs:modules:components:code-workflow")
