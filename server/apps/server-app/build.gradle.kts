...
dependencies {
    ...
    implementation(project(":server:ee:libs:automation:automation-command-center:automation-command-center-api"))
    implementation(project(":server:ee:libs:automation:automation-command-center:automation-command-center-graphql"))
    implementation(project(":server:ee:libs:automation:automation-command-center:automation-command-center-rest"))
    implementation(project(":server:ee:libs:automation:automation-command-center:automation-command-center-service"))
    implementation(project(":server:ee:libs:platform:platform-command-center:platform-command-center-api"))
    implementation(project(":server:ee:libs:platform:platform-command-center:platform-command-center-service"))
    ...
    implementation(project(":server:ee:libs:embedded:embedded-mcp:embedded-mcp-graphql"))
    implementation(project(":server:ee:libs:embedded:embedded-mcp:embedded-mcp-service"))
    ...
    implementation(project(":server:ee:libs:platform:platform-ai:platform-ai-skill:platform-ai-skill-service"))
