...
public interface UnifiedIntegrationMapper extends Converter<UnifiedIntegration, UnifiedIntegrationModel> {

    @Override
    UnifiedIntegrationModel convert(UnifiedIntegration unifiedIntegration);
}
