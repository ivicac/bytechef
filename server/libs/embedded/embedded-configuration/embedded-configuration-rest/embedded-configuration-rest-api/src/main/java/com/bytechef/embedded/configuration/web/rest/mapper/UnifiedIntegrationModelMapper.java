...
public interface UnifiedIntegrationModelMapper extends Converter<UnifiedIntegrationModel, UnifiedIntegration> {

    UnifiedIntegration convert(UnifiedIntegrationModel unifiedIntegrationModel);
}
