...
public class CacheConfiguration implements CachingConfigurer {
    ...
    private static final String WEBHOOK_RESUME_URL_CACHE =
        "com.bytechef.ee.platform.aihub.agent.WebhookResumeRegistry.resumeUrls";
    ...
    private static final String WORKFLOW_CHAT_JOB_CACHE =
        "com.bytechef.ee.platform.aihub.agent.WorkflowChatJobRegistry.jobIds";
    ...
    private static final String WORKFLOW_CHAT_LAST_TURN_CACHE =
        "com.bytechef.ee.platform.aihub.agent.WorkflowChatGuard.lastTurn";
    ...
    private static final String WORKFLOW_CHAT_IN_FLIGHT_CACHE =
        "com.bytechef.ee.platform.aihub.agent.WorkflowChatGuard.inFlight";
