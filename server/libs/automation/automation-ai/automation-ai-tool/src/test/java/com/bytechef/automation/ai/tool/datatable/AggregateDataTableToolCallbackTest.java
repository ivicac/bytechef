...
class AggregateDataTableToolCallbackTest {
    ...
    void testCallAggregatesSumAndCount() throws Exception {
        ...
        when(dataTableRowService.listRows(
            eq(DataTableRef.shared("orders", 0L, PlatformType.AUTOMATION)), anyInt(), eq(0)))
                .thenReturn(List.of(
    ...
    void testCallReturnsGroupedResults() throws Exception {
        ...
        when(dataTableRowService.listRows(
            eq(DataTableRef.shared("sales", 0L, PlatformType.AUTOMATION)), anyInt(), eq(0)))
                .thenReturn(List.of(
    ...
    void testCallClampsRowLimitAtFiftyThousand() throws Exception {
        ...
        when(dataTableRowService.listRows(
            eq(DataTableRef.shared("bigdata", 0L, PlatformType.AUTOMATION)),
    ...
    void testCallEmitsTruncationWarningWhenAtMaxScan() throws Exception {
        ...
        when(dataTableRowService.listRows(
            eq(DataTableRef.shared("huge", 0L, PlatformType.AUTOMATION)),
    ...
    void testCallEmitsNotTruncatedWhenUnderMaxScan() throws Exception {
        ...
        when(dataTableRowService.listRows(
            eq(DataTableRef.shared("small", 0L, PlatformType.AUTOMATION)), anyInt(), eq(0)))
                .thenReturn(List.of(
