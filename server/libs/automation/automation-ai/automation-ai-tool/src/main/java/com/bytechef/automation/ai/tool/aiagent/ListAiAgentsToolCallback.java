...
public class ListAiAgentsToolCallback implements ToolCallback {
    ...
    private static final String DESCRIPTION = """
        ...
        (true once the agent has at least one published version), lastPublishedVersion, projectId (the
        project the agent belongs to). Call this first
    ...
    private static AiAgentSummary toSummary(AiAgentDTO agentDTO) {
        ...
        return new AiAgentSummary(
            ...
            agentDTO.lastPublishedVersion() > 0, agentDTO.lastPublishedVersion(), agentDTO.projectId());
    }
    ...
    public record AiAgentSummary(
        ...
        int lastPublishedVersion, long projectId) {
    }
}
