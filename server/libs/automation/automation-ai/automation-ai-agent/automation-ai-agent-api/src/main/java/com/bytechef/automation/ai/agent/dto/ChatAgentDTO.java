 ...
 *
 * <p>
 * A separate row type (and a separate query) rather than more {@code ChatWorkflow} rows because the client names these
 * chats after the agent: the agent's identity (id/name/title), not its project's, is what the client shows.
 * </p>
 *
