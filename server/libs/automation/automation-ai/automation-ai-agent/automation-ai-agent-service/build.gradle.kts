dependencies {
    ...
    // Real WorkflowTestConfigurationService bean (the interface is already on the main classpath via
    // platform-configuration-api) — the facade syncs draft test connections through it.
