...
import com.bytechef.platform.ai.tool.spi.McpServerWorkspaceToolProvider;
 ...
 * {@link McpServerWorkspaceToolProvider} beans (e.g. the EE Context Store provider) alongside the existing
...
class AutomationMcpServerConfigurationTest {
    ...
    void testBuildToolSpecificationsAppendsContributedCallbacks() {
        ...
        McpServerWorkspaceToolProvider contextStoreProvider = mock(McpServerWorkspaceToolProvider.class);
        McpServerWorkspaceToolProvider otherProvider = mock(McpServerWorkspaceToolProvider.class);
        ...
        ObjectProvider<McpServerWorkspaceToolProvider> providers = stubProvider(
    ...
    void testBuildToolSpecificationsWithoutAnyProviderReturnsEmpty() {
        ...
        ObjectProvider<McpServerWorkspaceToolProvider> providers = stubProvider(List.of());
    ...
    void testBuildToolSpecificationsWhenWorkspaceUnassignedSkipsProviders() {
        ...
        McpServerWorkspaceToolProvider provider = mock(McpServerWorkspaceToolProvider.class);
        ...
        ObjectProvider<McpServerWorkspaceToolProvider> providers = stubProvider(List.of(provider));
    ...
    private static ObjectProvider<McpServerWorkspaceToolProvider> stubProvider(
        List<McpServerWorkspaceToolProvider> providers) {

        ObjectProvider<McpServerWorkspaceToolProvider> objectProvider = mock(ObjectProvider.class);
