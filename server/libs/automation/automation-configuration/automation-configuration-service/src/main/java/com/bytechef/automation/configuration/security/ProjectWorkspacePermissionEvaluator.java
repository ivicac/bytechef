 ...
 *
 * <p>
 * The three object-permission checks use the id+type overload; the two non-object checks use sentinel identifiers —
 * {@code hasPermission(#id, 'User', 'SELF')} for the current-user check and the target-less
 * {@code hasPermission('Tenant', 'ADMIN')} for the tenant-admin check.
 *
 * <p>
