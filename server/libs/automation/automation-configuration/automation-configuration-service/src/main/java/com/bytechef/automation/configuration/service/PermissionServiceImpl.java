 ...
 * expressions like {@code hasPermission(#id, 'ProjectScope', 'WORKFLOW_VIEW')} stay green on CE deployments. The EE
 * counterpart in {@code com.bytechef.ee.automation.configuration.service.PermissionServiceImpl} provides real checks.
 * Both beans are declared with {@code @ConditionalOnXEVersion} so exactly one is loaded per edition.
 *
 * <p>
