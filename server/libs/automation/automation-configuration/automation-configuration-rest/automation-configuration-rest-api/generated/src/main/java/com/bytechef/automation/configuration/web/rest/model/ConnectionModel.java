...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-31T18:15:27.955100+02:00[Europe/Zagreb]", comments = "Generator version: 7.24.0")
public class ConnectionModel {
  ...
  public ConnectionModel active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ConnectionModel baseUri(@Nullable String baseUri) {
  ...
  public ConnectionModel createdBy(@Nullable String createdBy) {
  ...
  public ConnectionModel lastModifiedBy(@Nullable String lastModifiedBy) {
  ...
  public ConnectionModel lastModifiedDate(@Nullable OffsetDateTime lastModifiedDate) {
  ...
  public ConnectionModel workspaceId(@Nullable Long workspaceId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, managed, authorizationType, authorizationParameters, baseUri, componentName, connectionParameters, connectionVersion, createdBy, createdDate, credentialStatus, credentialStoreType, environmentId, id, lastModifiedBy, lastModifiedDate, name, parameters, shared, tags, status, visibility, version, workspaceId);
  }
