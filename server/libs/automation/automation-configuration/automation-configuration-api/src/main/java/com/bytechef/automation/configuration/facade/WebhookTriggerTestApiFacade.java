...
public interface WebhookTriggerTestApiFacade {
    ...
    String enableTrigger(String workflowId, @Nullable String triggerName, long environmentId);

    void disableTrigger(String workflowId, @Nullable String triggerName, long environmentId);
}
