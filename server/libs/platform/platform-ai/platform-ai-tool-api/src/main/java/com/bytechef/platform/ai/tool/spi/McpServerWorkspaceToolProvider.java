 ...
 *
 * <p>
 * Implementations may live in CE or EE modules. CE-only deployments without any EE provider (e.g. when the EE Context
 * Store module is absent) simply see no extra callbacks; the McpServer continues to expose the component/workflow tool
 * surface unchanged.
 * </p>
 *
 * @author Ivica Cardic
 */
public interface McpServerWorkspaceToolProvider {
