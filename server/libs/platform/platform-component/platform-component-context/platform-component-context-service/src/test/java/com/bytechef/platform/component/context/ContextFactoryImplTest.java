...
class ContextFactoryImplTest {
    ...
    private static ContextFactoryImpl newContextFactory() {
        ...
        return new ContextFactoryImpl(
            ...
            mock(DataStorage.class), mock(EditorLogFileStorage.class), mock(ApplicationEventPublisher.class),
            fileStorageServiceRegistry, mock(ObjectProvider.class), mock(ObjectProvider.class),
            mock(LogFileStorage.class), mock(TempFileStorage.class), mock(Tracer.class),
            mock(TriggerLogFileStorage.class));
    }
