...
public interface TriggerDefinitionService extends OperationDefinitionService {
    ...
    /**
     * Returns {@code true} when the trigger's owning component declares a connection definition. Used by AI Hub tooling
     * (e.g., the {@code lookupTriggerPropertyOptions} tool callback) to decide whether a property-options lookup must
