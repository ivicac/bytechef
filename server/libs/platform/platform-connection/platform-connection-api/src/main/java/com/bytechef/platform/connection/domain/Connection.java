...
public final class Connection implements CredentialSecret {
     ...
     * writes are a silent no-op so idempotent callers (e.g. a promote re-setting visibility to WORKSPACE) are
     * unaffected. Related invariants remain the caller's responsibility (typically {@code WorkspaceConnectionFacade}).
     *
     * <p>
