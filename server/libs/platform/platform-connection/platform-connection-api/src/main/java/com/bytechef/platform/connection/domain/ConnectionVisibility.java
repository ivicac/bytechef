 ...
 * persisted row on upgrade. Hierarchy: PRIVATE &lt; WORKSPACE &lt; ORGANIZATION.
 *
 * <p>
...
public enum ConnectionVisibility {
    ...
    WORKSPACE(1), // Visible to all workspace members
    ORGANIZATION(2); // Visible to all members across all workspaces
    ...
    private static final Set<ConnectionVisibility> PRIVATE_TRANSITIONS = Set.of(WORKSPACE, ORGANIZATION);
    private static final Set<ConnectionVisibility> WORKSPACE_TRANSITIONS = Set.of(PRIVATE);
    ...
    /**
     * Returns true if this visibility level is at least as broad as the given level. Hierarchy: PRIVATE &lt; WORKSPACE
     * &lt; ORGANIZATION.
     */
