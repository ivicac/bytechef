...
package com.bytechef.platform.custom_component.configuration.public_.web.rest;

import com.bytechef.platform.custom_component.configuration.domain.CustomComponent.Language;
import com.bytechef.platform.custom_component.configuration.facade.CustomComponentFacade;
import com.bytechef.platform.custom_component.configuration.public_web.rest.CustomComponentApi;
...
//    @PreAuthorize("hasAuthority(\"" + AuthorityConstants.ADMIN + "\")")
    public ResponseEntity<Void> deployCustomComponent(MultipartFile componentFile) {
        try {
            customComponentFacade.save(componentFile.getBytes(), Language.of(componentFile.getOriginalFilename()));
        } catch (IOException e) {
