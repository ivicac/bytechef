...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    apiPackage.set("com.bytechef.platform.custom_component.configuration.public_web.rest")
    configOptions.set(
        mapOf(
    ...
    modelPackage.set("com.bytechef.platform.custom_component.configuration.public_web.rest.model")
