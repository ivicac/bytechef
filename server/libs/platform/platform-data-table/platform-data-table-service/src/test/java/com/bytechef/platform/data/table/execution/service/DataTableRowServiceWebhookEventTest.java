 ...
 * revert of any one of them to {@code DataTableRef.shared(...)} would send that account's records to the vendor's URL
...
class DataTableRowServiceWebhookEventTest {
    ...
    void testASharedTablesRowCarriesTheSharedTable() {
        ...
        DataTableRef dataTableRef = DataTableRef.shared("invoices", ENVIRONMENT_ID, PlatformType.EMBEDDED);
    ...
    void testAnAutomationRowCarriesItsOwnPool() {
        ...
        dataTableRowService.deleteRow(DataTableRef.shared("invoices", ENVIRONMENT_ID, PlatformType.AUTOMATION), 1L);
    ...
    void testTheEventCarriesTheAffectedRowId() {
        ...
        dataTableRowService.deleteRow(DataTableRef.shared("invoices", ENVIRONMENT_ID, PlatformType.EMBEDDED), 7L);
    ...
    private static DataTableRef ownedDataTableRef() {
        ...
        return new DataTableRef("invoices", ENVIRONMENT_ID, PlatformType.EMBEDDED, accountOwner, accountOwner);
    }
