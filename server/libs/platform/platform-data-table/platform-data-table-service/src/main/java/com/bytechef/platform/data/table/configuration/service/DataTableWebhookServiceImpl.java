...
public class DataTableWebhookServiceImpl implements DataTableWebhookService {
    ...
    public long addWebhook(DataTableRef dataTableRef, String url, DataTableWebhookType type) {
        ...
        // The run owner, not the resource owner: on a shared table the resource owner is null for every account, which
        // is precisely the case the registration owner exists to separate. setOwner moves both columns together.
