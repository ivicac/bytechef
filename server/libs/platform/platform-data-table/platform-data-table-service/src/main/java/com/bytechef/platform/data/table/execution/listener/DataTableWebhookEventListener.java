 ...
 * sufficient -- a registration hangs off one table, a table has one owner -- but a shared table has no owner and holds
 * many accounts' rows, so on one the event's ref is the only thing that says whose row this is.
 *
 * <p>
