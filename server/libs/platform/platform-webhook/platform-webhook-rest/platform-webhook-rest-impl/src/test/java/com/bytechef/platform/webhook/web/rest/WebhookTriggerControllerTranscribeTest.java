...
class WebhookTriggerControllerTranscribeTest {
    ...
    void setUp() {
        ...
        // isWorkflowDisabled now delegates to the executor; the mock returns false by default, so the webhook is
        // treated as enabled and the transcribe endpoint proceeds.
        WebhookTriggerController controller = new WebhookTriggerController(
            applicationProperties, fileEntryTokens, tempFileStorage, transcribeService, webhookWorkflowExecutor);
