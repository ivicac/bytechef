...
class AbstractWebhookTriggerControllerTest {
    ...
    void testConvertToFileEntryUrlEmitsSignedToken() {
        ...
        TestableController controller = new TestableController(
            fileEntryTokens,
            mock(JobPrincipalAccessorRegistry.class),
            PUBLIC_URL,
            mock(TempFileStorage.class),
    ...
    private static class TestableController extends AbstractWebhookTriggerController {
        ...
        TestableController(
            ...
            String publicUrl, TempFileStorage tempFileStorage,
            TriggerDefinitionService triggerDefinitionService, WorkflowService workflowService) {

            super(fileEntryTokens, jobPrincipalAccessorRegistry, publicUrl, tempFileStorage,
                triggerDefinitionService, null, workflowService);
        }
    }
}
