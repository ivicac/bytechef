...
@MockitoBean(types = {
    ...
    DateTimeMapper.class, EnvironmentService.class, FileEntryTokens.class, OAuth2ParametersFacade.class,
    OAuth2Service.class, TaskDispatcherDefinitionService.class, TriggerDefinitionFacade.class,
