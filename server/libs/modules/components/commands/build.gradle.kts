...
dependencies {
    ...
    // ProcessTaskRunner and TaskRunnerRegistryImpl are needed to build a real, deterministic registry for the
    // definition snapshot test, mirroring script's ScriptComponentHandlerTest arrangement.
