...
package com.bytechef.component.instagram.business.connection;
 ...
 * @author Ivica Cardic
 */
public class InstagramBusinessConnection {
    ...
    public static final ModifiableConnectionDefinition CONNECTION_DEFINITION = connection()
        ...
        .authorizations(
            authorization(AuthorizationType.OAUTH2_AUTHORIZATION_CODE)
                ...
                .tokenUrl(
                    (connectionParameters, context) -> "https://graph.facebook.com/v19.0/oauth/access_token"));

    private static Map<String, Boolean> getScopes() {
        Map<String, Boolean> map = new LinkedHashMap<>();

        map.put("instagram_basic", true);
        map.put("instagram_content_publish", true);
    ...
    private InstagramBusinessConnection() {
    }
}
