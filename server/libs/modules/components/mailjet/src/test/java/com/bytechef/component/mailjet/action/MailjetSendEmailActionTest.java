...
class MailjetSendEmailActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FROM_EMAIL, "sender@example.com", TO_EMAIL, "jane@example.com", SUBJECT, "Hello", TEXT, "Hi there"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = MailjetSendEmailAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/v3.1/send", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(
            "Messages", List.of(
                Map.of(
                    "From", Map.of("Email", "sender@example.com"),
                    "To", List.of(Map.of("Email", "jane@example.com")),
                    "Subject", "Hello",
                    "TextPart", "Hi there")));
