...
class FreshserviceCreateTicketActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(SUBJECT, "Laptop issue", DESCRIPTION, "<p>Details</p>", EMAIL, "jane@example.com", PRIORITY, 1,
            STATUS, 2));
    ...
    void testPerform(
        ...
        Map<String, Object> result = FreshserviceCreateTicketAction.perform(
