...
class DeeplTranslateTextActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = DeeplTranslateTextAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/translate", stringArgumentCaptor.getValue());
