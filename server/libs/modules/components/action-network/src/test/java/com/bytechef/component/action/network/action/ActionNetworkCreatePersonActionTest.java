...
class ActionNetworkCreatePersonActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(EMAIL, "john@example.com", GIVEN_NAME, "John", FAMILY_NAME, "Doe"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = ActionNetworkCreatePersonAction.perform(
        ...
        Map<String, Object> expectedBody = Map.of(
            PERSON, Map.of(
                "email_addresses", List.of(Map.of("address", "john@example.com")),
                GIVEN_NAME, "John",
                FAMILY_NAME, "Doe"));
