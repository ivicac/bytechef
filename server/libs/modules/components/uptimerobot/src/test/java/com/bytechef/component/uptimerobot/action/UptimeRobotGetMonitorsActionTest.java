...
class UptimeRobotGetMonitorsActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = UptimeRobotGetMonitorsAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/getMonitors", stringArgumentCaptor.getValue());
