...
class GetResponseCreateContactActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(CAMPAIGN_ID, "campaign-1", EMAIL, "jane@example.com", NAME, "Jane Doe"));
    ...
    void testPerform(
        ...
        Object result = GetResponseCreateContactAction.perform(mockedParameters, mockedParameters, mockedContext);
        ...
        Map<String, Object> expectedBody = Map.of(
            ...
            "campaign", Map.of(CAMPAIGN_ID, "campaign-1"),
            NAME, "Jane Doe");
