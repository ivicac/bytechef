...
class SemanticScholarSearchPapersActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(QUERY, "large language models", LIMIT, 10, FIELDS, "title,abstract,year"));
    ...
    void testPerform(
        ...
        Object result = SemanticScholarSearchPapersAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("total", 1), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/paper/search", stringArgumentCaptor.getValue());
