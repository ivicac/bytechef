...
class GhostListPostsActionTest {
    ...
    void testPerform(
        ...
        when(mockedResponse.getBody())
            .thenReturn(Map.of("posts", List.of()));

        Object result = GhostListPostsAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("posts", List.of()), result);
