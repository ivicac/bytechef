...
class MessageBirdSendSmsActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ORIGINATOR, "MyBrand", RECIPIENTS, "+31612345678", BODY, "Hello"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = MessageBirdSendSmsAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("id", "msg-1"), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/messages", stringArgumentCaptor.getValue());
        ...
        Body expectedBody = Body.of(
            ORIGINATOR, "MyBrand",
            RECIPIENTS, List.of("+31612345678"),
            BODY, "Hello");
