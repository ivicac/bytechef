...
package com.bytechef.component.pushbullet.connection;
...
public class PushbulletConnection {
    ...
    public static final ModifiableConnectionDefinition CONNECTION_DEFINITION = connection()
        .baseUri((connectionParameters, context) -> "https://api.pushbullet.com/v2")
        .authorizations(
            authorization(AuthorizationType.API_KEY)
                ...
                .properties(
                    ...
                    string(VALUE)
                        .label("API Key")
                        .description(
                            "The Access Token from your Pushbullet account settings " +
                    ...
                    string(ADD_TO)
                        ...
                        .required(true)))
        .version(1)
        .help("", "https://docs.bytechef.io/reference/components/pushbullet_v1#connection-setup");

    private PushbulletConnection() {
    }
}
