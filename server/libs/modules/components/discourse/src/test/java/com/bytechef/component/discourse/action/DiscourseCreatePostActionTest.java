...
class DiscourseCreatePostActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = DiscourseCreatePostAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/posts.json", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(TITLE, "New Topic", RAW, "Post content", CATEGORY, 5);
