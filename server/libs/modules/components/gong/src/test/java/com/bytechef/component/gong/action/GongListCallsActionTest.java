...
class GongListCallsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FROM_DATE_TIME, "2025-01-01T00:00:00Z", TO_DATE_TIME, "2025-01-31T23:59:59Z"));
    ...
    void testPerform(
        ...
        when(mockedResponse.getBody())
            .thenReturn(Map.of("calls", List.of()));

        Object result = GongListCallsAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("calls", List.of()), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/calls", stringArgumentCaptor.getValue());
