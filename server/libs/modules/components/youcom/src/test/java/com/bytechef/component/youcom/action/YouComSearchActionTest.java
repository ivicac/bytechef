...
class YouComSearchActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(QUERY, "restaurants in Zagreb", NUM_WEB_RESULTS, 5, COUNTRY, "HR"));
    ...
    void testPerform(
        ...
        when(mockedResponse.getBody())
            .thenReturn(Map.of("hits", List.of()));

        Object result = YouComSearchAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("hits", List.of()), result);
