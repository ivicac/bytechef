...
class GoogleAnalyticsRunReportActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(
            PROPERTY_ID, "123456789", START_DATE, "7daysAgo", END_DATE, "today",
    ...
    void testPerform(
        ...
        Map<String, Object> result = GoogleAnalyticsRunReportAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/properties/123456789:runReport", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(
            "dateRanges", List.of(Map.of(START_DATE, "7daysAgo", END_DATE, "today")),
            METRICS, List.of(Map.of("name", "activeUsers"), Map.of("name", "sessions")),
            DIMENSIONS, List.of(Map.of("name", "country")));
