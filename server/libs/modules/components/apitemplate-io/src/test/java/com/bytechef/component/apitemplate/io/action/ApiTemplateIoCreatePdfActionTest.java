...
class ApiTemplateIoCreatePdfActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(TEMPLATE_ID, "template-123", DATA, Map.of("invoice_number", "INV-001")));
    ...
    void testPerform(
        ...
        Map<String, Object> result = ApiTemplateIoCreatePdfAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/create-pdf", stringArgumentCaptor.getValue());
        ...
        assertEquals(Body.of(Map.of("invoice_number", "INV-001")), bodyArgumentCaptor.getValue());
    }
}
