...
class ListenNotesSearchActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(Q, "artificial intelligence", TYPE, "episode", LANGUAGE, "English"));
    ...
    void testPerform(
        ...
        Object result = ListenNotesSearchAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("total", 100), result);
