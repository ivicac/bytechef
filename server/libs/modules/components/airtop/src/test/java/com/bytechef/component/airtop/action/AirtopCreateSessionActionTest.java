...
class AirtopCreateSessionActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = AirtopCreateSessionAction.perform(
        ...
        Map<String, Object> expectedBody = Map.of(CONFIGURATION, Map.of(TIMEOUT_MINUTES, 15));
