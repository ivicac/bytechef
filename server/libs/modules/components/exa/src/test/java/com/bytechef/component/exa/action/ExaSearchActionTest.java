...
class ExaSearchActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = ExaSearchAction.perform(mockedParameters, mockedParameters, mockedContext);
