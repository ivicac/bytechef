 ...
 * @author Ivica Cardic
 */
public class LeadmagicValidateEmailAction {
            ...
            outputSchema(
                object()
                    .properties(
                        ...
                        string("email_status"),
                        string("company_name"))))
        .perform(LeadmagicValidateEmailAction::perform);

    private LeadmagicValidateEmailAction() {
    }

    public static Object perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        return context.http(http -> http.post("/v1/people/email-validation"))
