...
class FoursquareSearchPlacesActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(QUERY, "coffee", NEAR, "Chicago, IL", LIMIT, 10));
    ...
    void testPerform(
        ...
        Object result = FoursquareSearchPlacesAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("results", List.of()), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/places/search", stringArgumentCaptor.getValue());
