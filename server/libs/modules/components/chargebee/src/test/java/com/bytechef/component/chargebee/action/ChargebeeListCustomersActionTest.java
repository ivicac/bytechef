...
class ChargebeeListCustomersActionTest {
    ...
    void testPerform(
        ...
        Object result = ChargebeeListCustomersAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("list", List.of()), result);
