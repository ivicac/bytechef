...
class RaindropCreateBookmarkActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = RaindropCreateBookmarkAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("result", true), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/raindrop", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(LINK, "https://example.com", TITLE, "Example");
