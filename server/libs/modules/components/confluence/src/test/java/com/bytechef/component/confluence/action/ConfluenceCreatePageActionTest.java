...
class ConfluenceCreatePageActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(SPACE_ID, "space-1", TITLE, "Release Notes", BODY, "<p>Content</p>"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = ConfluenceCreatePageAction.perform(
        ...
        Map<String, Object> expectedBody = Map.of(
            SPACE_ID, "space-1",
            TITLE, "Release Notes",
            BODY, Map.of("representation", "storage", "value", "<p>Content</p>"));
