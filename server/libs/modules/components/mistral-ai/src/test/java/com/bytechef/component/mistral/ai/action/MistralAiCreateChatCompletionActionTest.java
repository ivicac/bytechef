...
class MistralAiCreateChatCompletionActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(MODEL, "mistral-small-latest", PROMPT, "Hello"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = MistralAiCreateChatCompletionAction.perform(
