...
class GristListRecordsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(DOC_ID, "doc-1", TABLE_ID, "Table1", LIMIT, 10));
    ...
    void testPerform(
        ...
        Object result = GristListRecordsAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("records", List.of()), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/docs/doc-1/tables/Table1/records", stringArgumentCaptor.getValue());
