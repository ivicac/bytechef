 ...
 * @author Ivica Cardic
 */
public class MicrosoftSqlServerComponentDefinitionTest {

    @Test
    public void testGetComponentDefinition() {
        JdbcComponentHandlerImpl jdbcComponentHandler = new JdbcComponentHandlerImpl(
            new MicrosoftSqlServerJdbcComponentHandler().getJdbcComponentDefinition());

        JsonFileAssert.assertEquals(
            "definition/microsoftSqlServer_v1.json", jdbcComponentHandler.getDefinition());
    }
}
