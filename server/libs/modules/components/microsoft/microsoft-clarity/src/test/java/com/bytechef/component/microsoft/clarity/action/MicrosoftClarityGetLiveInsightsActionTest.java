...
class MicrosoftClarityGetLiveInsightsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(NUM_OF_DAYS, 1, DIMENSION_1, "Browser"));
    ...
    void testPerform(
        ...
        when(mockedResponse.getBody())
            .thenReturn(List.of(Map.of("metricName", "Traffic")));

        Object result = MicrosoftClarityGetLiveInsightsAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(List.of(Map.of("metricName", "Traffic")), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/project-live-insights", stringArgumentCaptor.getValue());
