...
import com.bytechef.component.neon.action.NeonCreateProjectAction;
...
public class NeonComponentHandler implements ComponentHandler {
    ...
    private static final ComponentDefinition COMPONENT_DEFINITION = component("neon")
        .title("Neon")
        .version(1)
        .description("Neon is a serverless Postgres platform with branching, autoscaling and instant provisioning.")
        .customAction(true)
        .icon("path:assets/neon.svg")
        .categories(ComponentCategory.DEVELOPER_TOOLS)
        .connection(NeonConnection.CONNECTION_DEFINITION)
        .actions(NeonCreateProjectAction.ACTION_DEFINITION)
        .clusterElements(tool(NeonCreateProjectAction.ACTION_DEFINITION));
