...
class BrowserbaseCreateSessionActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = BrowserbaseCreateSessionAction.perform(
        ...
        assertEquals(Body.of(Map.of(PROJECT_ID, "project-123")), bodyArgumentCaptor.getValue());
    }
}
