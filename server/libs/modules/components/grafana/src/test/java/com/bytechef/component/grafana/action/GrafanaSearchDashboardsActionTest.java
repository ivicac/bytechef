...
class GrafanaSearchDashboardsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(Map.of(QUERY, "cpu", LIMIT, 10));
    ...
    void testPerform(
        ...
        when(mockedResponse.getBody())
            .thenReturn(List.of(Map.of("uid", "abc")));

        Object result = GrafanaSearchDashboardsAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(List.of(Map.of("uid", "abc")), result);
