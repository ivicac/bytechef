...
class ZohoBiginListContactsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FIELDS, "First_Name,Last_Name,Email", PER_PAGE, 20));
    ...
    void testPerform(
        ...
        Object result = ZohoBiginListContactsAction.perform(mockedParameters, mockedParameters, mockedContext);
