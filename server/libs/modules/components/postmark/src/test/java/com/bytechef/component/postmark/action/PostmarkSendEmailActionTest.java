...
class PostmarkSendEmailActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(
            FROM, "sender@example.com", TO, "receiver@example.com", SUBJECT, "Hello",
            TEXT_BODY, "Hello from ByteChef"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = PostmarkSendEmailAction.perform(
