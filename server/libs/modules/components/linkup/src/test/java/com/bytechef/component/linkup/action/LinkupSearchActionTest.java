...
class LinkupSearchActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(Q, "What is ByteChef?", DEPTH, "standard", OUTPUT_TYPE, "sourcedAnswer", INCLUDE_IMAGES, false));
    ...
    void testPerform(
        ...
        Map<String, Object> result = LinkupSearchAction.perform(mockedParameters, mockedParameters, mockedContext);
