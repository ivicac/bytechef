...
package com.bytechef.component.aws.transcribe.connection;
 ...
 * @author Ivica Cardic
 */
public class AwsTranscribeConnection {
        ...
        .authorizations(
            authorization(AuthorizationType.CUSTOM)
                .properties(
                    ...
                    string(REGION)
                        .label("Region")
                        .description("The AWS region used for Transcribe (e.g. us-east-1).")
                        .required(true)
                        .defaultValue("us-east-1")));

    private AwsTranscribeConnection() {
    }
}
