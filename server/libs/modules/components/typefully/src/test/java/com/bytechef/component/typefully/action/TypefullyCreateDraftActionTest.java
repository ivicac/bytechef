...
class TypefullyCreateDraftActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = TypefullyCreateDraftAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/drafts/", stringArgumentCaptor.getValue());
