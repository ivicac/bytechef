...
class TeamleaderCreateContactActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(LAST_NAME, "Doe", FIRST_NAME, "John", EMAIL, "john@example.com"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = TeamleaderCreateContactAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/contacts.add", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(
            LAST_NAME, "Doe",
            FIRST_NAME, "John",
            "emails", List.of(Map.of("type", "primary", EMAIL, "john@example.com")));
