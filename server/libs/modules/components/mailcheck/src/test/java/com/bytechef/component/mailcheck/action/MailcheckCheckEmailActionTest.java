...
class MailcheckCheckEmailActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = MailcheckCheckEmailAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/singleEmail:check", stringArgumentCaptor.getValue());

        ConfigurationBuilder configurationBuilder = configurationBuilderArgumentCaptor.getValue();
        Configuration configuration = configurationBuilder.build();

        assertEquals(ResponseType.JSON, configuration.getResponseType());
        assertEquals(Body.of(Map.of(EMAIL, "john@example.com")), bodyArgumentCaptor.getValue());
    }
}
