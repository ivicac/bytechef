 ...
 * @author Ivica Cardic
 */
public class AircallListContactsAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("listContacts")
        .title("List Contacts")
        .description("Lists the contacts in the Aircall account.")
        .properties(
            integer("perPage")
                .label("Per Page")
        ...
        .perform(AircallListContactsAction::perform);

    private AircallListContactsAction() {
    }

    public static Object perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        return context.http(http -> http.get("/contacts"))
            .queryParameters("per_page", inputParameters.getInteger("perPage"))
