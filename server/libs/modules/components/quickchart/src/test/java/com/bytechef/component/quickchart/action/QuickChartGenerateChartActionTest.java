...
class QuickChartGenerateChartActionTest {
    ...
    void testPerform(
        ...
        Object result = QuickChartGenerateChartAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(mockedFileEntry, result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("https://quickchart.io/chart", stringArgumentCaptor.getValue());
