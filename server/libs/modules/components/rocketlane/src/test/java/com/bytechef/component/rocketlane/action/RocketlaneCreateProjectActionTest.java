...
class RocketlaneCreateProjectActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(PROJECT_NAME, "Customer Onboarding", START_DATE, LocalDate.of(2026, 8, 1)));
    ...
    void testPerform(
        ...
        Map<String, Object> result = RocketlaneCreateProjectAction.perform(
