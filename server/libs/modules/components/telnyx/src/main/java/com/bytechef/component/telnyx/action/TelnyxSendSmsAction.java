...
package com.bytechef.component.telnyx.action;
 ...
 * @author Ivica Cardic
 */
public class TelnyxSendSmsAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("sendSms")
        ...
        .properties(
            string("from")
                .label("From")
                .description("The sending phone number in E.164 format. Must be a Telnyx number on your account.")
                .required(true),
            string("to")
                .label("To")
                    ...
                    .properties(
                        object("data")
                            .properties(
                                ...
                                string("type"),
                                string("text")))))
        .perform(TelnyxSendSmsAction::perform);

    private TelnyxSendSmsAction() {
    }
