...
class DropcontactEnrichContactActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(EMAIL, "jane@example.com", FIRST_NAME, "Jane", LAST_NAME, "Doe", COMPANY, "Acme"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = DropcontactEnrichContactAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("success", true), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/batch", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedContact = Map.of(
            EMAIL, "jane@example.com",
            FIRST_NAME, "Jane",
            LAST_NAME, "Doe",
            COMPANY, "Acme");

        assertEquals(Body.of(Map.of("data", List.of(expectedContact))), bodyArgumentCaptor.getValue());
    }
}
