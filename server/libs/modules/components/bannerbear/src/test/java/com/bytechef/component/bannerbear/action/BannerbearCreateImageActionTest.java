...
class BannerbearCreateImageActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(TEMPLATE, "template-1", MODIFICATIONS, List.of(Map.of("name", "title", "text", "Hello"))));
    ...
    void testPerform(
        ...
        Map<String, Object> result = BannerbearCreateImageAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/images", stringArgumentCaptor.getValue());
        ...
        Body expectedBody = Body.of(
            TEMPLATE, "template-1",
            MODIFICATIONS, List.of(Map.of("name", "title", "text", "Hello")));
