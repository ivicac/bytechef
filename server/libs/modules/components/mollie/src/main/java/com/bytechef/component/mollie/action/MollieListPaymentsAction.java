...
package com.bytechef.component.mollie.action;
 ...
 * @author Ivica Cardic
 */
public class MollieListPaymentsAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("listPayments")
        .title("List Payments")
        .description("Returns the payments created in your Mollie account.")
        .properties(
            integer("limit")
                .label("Limit")
                                            ...
                                            .properties(
                                                ...
                                                object("amount")
                                                    .properties(
                                                        string("value"),
                                                        string("currency"))))))))
        .perform(MollieListPaymentsAction::perform);

    private MollieListPaymentsAction() {
    }
