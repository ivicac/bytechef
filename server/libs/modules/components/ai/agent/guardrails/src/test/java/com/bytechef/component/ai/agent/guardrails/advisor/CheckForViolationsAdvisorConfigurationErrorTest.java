...
class CheckForViolationsAdvisorConfigurationErrorTest {
    ...
    @Test
    void illegalArgumentExceptionBlocksAsConfigurationError() {
        ...
        CheckForViolationsAdvisor advisor = CheckForViolationsAdvisor.builder()
            ...
            .add("piiCheck", misconfigured, empty, empty, empty, empty, Map.of(), null)
    ...
    @Test
    void patternSyntaxExceptionBlocksAsConfigurationError() {
        GuardrailCheckFunction misconfigured = (text, context) -> {
        ...
        CheckForViolationsAdvisor advisor = CheckForViolationsAdvisor.builder()
            .blockedMessage("blocked")
            .add("secretKeysCheck", misconfigured, empty, empty, empty, empty, Map.of(), null)
            .context(mock(Context.class))
            .build();
    ...
    @Test
    void illegalStateExceptionBlocksAsConfigurationError() {
    ...
    @Test
    void nullPointerExceptionBlocksAsConfigurationError() {
        ...
        CheckForViolationsAdvisor advisor = CheckForViolationsAdvisor.builder()
            .blockedMessage("blocked")
            .add("brokenCheck", broken, empty, empty, empty, empty, Map.of(), null)
            .context(mock(Context.class))
            .build();
    ...
    @Test
    void classCastExceptionBlocksAsConfigurationError() {
    ...
    void configurationCauseSurfacesAsConfigurationFailureKind() {
        ...
        assertThat(surfaced)
            .singleElement()
            .satisfies(view -> assertThat(view.get("failureKind")).isEqualTo("IllegalArgumentException"));
    }
    ...
    void detectionTimeoutExceptionBlocksAsConfigurationError() {
        ...
        CheckForViolationsAdvisor advisor = CheckForViolationsAdvisor.builder()
            .blockedMessage("blocked")
            .add("customRegexCheck", pathological, empty, empty, empty, empty, Map.of(), null)
            .context(mock(Context.class))
            .build();
