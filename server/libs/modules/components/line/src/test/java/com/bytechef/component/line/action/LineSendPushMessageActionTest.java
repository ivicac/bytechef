...
class LineSendPushMessageActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = LineSendPushMessageAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/message/push", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(
            TO, "U1234567890",
            MESSAGES, List.of(Map.of("type", "text", TEXT, "Hello from ByteChef")));
