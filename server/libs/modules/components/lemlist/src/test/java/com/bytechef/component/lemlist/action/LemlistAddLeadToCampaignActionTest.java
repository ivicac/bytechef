...
class LemlistAddLeadToCampaignActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(CAMPAIGN_ID, "cam_123", EMAIL, "john@example.com", FIRST_NAME, "John", LAST_NAME, "Doe"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = LemlistAddLeadToCampaignAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/campaigns/cam_123/leads/john@example.com", stringArgumentCaptor.getValue());
