...
class FirefliesGetTranscriptsActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> result = FirefliesGetTranscriptsAction.perform(
        ...
        assertTrue(String.valueOf(contentMap.get("query"))
            .contains("transcripts(limit: $limit)"));
        assertEquals(Map.of(LIMIT, 5), contentMap.get("variables"));
    }
}
