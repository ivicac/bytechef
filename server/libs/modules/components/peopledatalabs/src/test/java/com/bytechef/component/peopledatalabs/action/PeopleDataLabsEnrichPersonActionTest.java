...
class PeopleDataLabsEnrichPersonActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(EMAIL, "john@example.com", NAME, "John Doe", MIN_LIKELIHOOD, 6));
    ...
    void testPerform(
        ...
        Object result = PeopleDataLabsEnrichPersonAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of("status", 200), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/person/enrich", stringArgumentCaptor.getValue());
