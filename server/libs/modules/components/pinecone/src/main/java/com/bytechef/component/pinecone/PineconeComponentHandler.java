...
import com.bytechef.component.pinecone.action.PineconeListIndexesAction;
...
public class PineconeComponentHandler implements ComponentHandler {
    ...
    private static final ComponentDefinition COMPONENT_DEFINITION = component("pinecone")
        .title("Pinecone")
        .version(1)
        .description("Pinecone is a managed vector database for machine learning applications.")
        .customAction(true)
        .icon("path:assets/pinecone.svg")
        .categories(ComponentCategory.ARTIFICIAL_INTELLIGENCE)
        .connection(PineconeConnection.CONNECTION_DEFINITION)
        .actions(PineconeListIndexesAction.ACTION_DEFINITION)
        .clusterElements(tool(PineconeListIndexesAction.ACTION_DEFINITION));
