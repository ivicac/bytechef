...
class ConvertKitAddSubscriberToFormActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FORM_ID, "123", EMAIL, "jane@example.com", FIRST_NAME, "Jane"));
    ...
    void testPerform(
        ...
        Map<String, Object> result = ConvertKitAddSubscriberToFormAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/forms/123/subscribe", stringArgumentCaptor.getValue());
        ...
        Map<String, Object> expectedBody = Map.of(EMAIL, "jane@example.com", FIRST_NAME, "Jane");
