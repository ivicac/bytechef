...
public class BranchTaskDispatcherIntTest {
    ...
    public void testDispatchOutputCaseMatch() {
        ...
        Assertions.assertEquals(caseOutputs("k1", "last task output", "default", null), outputs.get("result"));
    }
    ...
    public void testDispatchOutputLiteralValue() {
        ...
        Assertions.assertEquals(caseOutputs("k1", "literal value", "default", null), outputs.get("result"));
    }
    ...
    public void testDispatchOutputDefault() {
        ...
        Assertions.assertEquals(caseOutputs("k1", null, "default", "default output"), outputs.get("result"));
    }

    private static Map<String, Object> caseOutputs(
        String firstKey, Object firstValue, String secondKey, Object secondValue) {

        Map<String, Object> caseOutputs = new HashMap<>();

        caseOutputs.put(firstKey, firstValue);
        caseOutputs.put(secondKey, secondValue);
