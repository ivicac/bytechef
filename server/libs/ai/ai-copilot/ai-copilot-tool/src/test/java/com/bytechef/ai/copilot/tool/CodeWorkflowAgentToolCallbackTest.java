...
class CodeWorkflowAgentToolCallbackTest {

    private final JsonMapper jsonMapper = new JsonMapper();

    @Test
    void testCallReturnsResultWhenSubagentSucceeds() {
        String synthesised = "## Code Workflows\n\n1. my-project — created and compiled.";
        ...
        when(codeWorkflowChatClient.prompt(anyString())).thenReturn(requestSpec);
