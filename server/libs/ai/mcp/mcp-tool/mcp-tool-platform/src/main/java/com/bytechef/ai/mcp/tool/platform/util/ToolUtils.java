...
public final class ToolUtils {
     ...
     * underlying property implements {@link OptionsDataSourceAware} with a non-null {@link OptionsDataSource}. The
     * fields signal to AI Hub's workflow_editor_agent subagent that the property requires a dynamic-options lookup
     * before a value can be written. Properties without an options data source are returned unchanged so existing
