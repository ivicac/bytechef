...
import com.bytechef.ee.ai.hub.tool.ListMcpProjectWorkflowsToolCallback;
...
import com.bytechef.ee.ai.hub.tool.UpdateMcpProjectWorkflowParametersToolCallback;
...
public class McpManagerConfiguration {
    ...
    static ManagerSubAgentToolCallback createMcpManagerToolCallback(ChatClient mcpManagerChatClient) {
        return new ManagerSubAgentToolCallback(AiHubAgentType.MCP_MANAGER, mcpManagerChatClient, TOOL_DESCRIPTION);
    }
