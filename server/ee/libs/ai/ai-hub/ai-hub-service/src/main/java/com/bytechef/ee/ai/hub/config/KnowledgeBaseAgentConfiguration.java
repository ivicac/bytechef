 ...
 * and the AI Hub Knowledge Base subagent {@link ChatClient} beans. These beans live in EE (not the CE
 * {@code CopilotConfiguration}, where the other Copilot panel source agents live) because
 * {@link KnowledgeBaseToolCallbacksFactory} and the knowledge-base services/facades it wraps are EE.
 *
 * <p>
