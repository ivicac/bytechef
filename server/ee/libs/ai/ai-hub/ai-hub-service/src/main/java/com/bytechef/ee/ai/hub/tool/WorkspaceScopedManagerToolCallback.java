 ...
 * inject the workspace-scoped {@link AiHubToolInvocationContext}. The wrapper extends the delegate's input with an
 ...
 * {@link AiHubToolInvocationContext#TOOL_CONTEXT_WORKSPACE_ID_KEY} — exactly what the specialist's workspace-scoped
...
public class WorkspaceScopedManagerToolCallback implements ToolCallback {
    ...
    public String call(String toolInput, @Nullable ToolContext toolContext) {
        try {
            ...
            forwardedContext.put(AiHubToolInvocationContext.TOOL_CONTEXT_WORKSPACE_ID_KEY, workspaceId);
