...
/**
 * Workspace ↔ {@link com.bytechef.ee.ai.hub.personalagent.AiHubPersonalAgent} membership row. Mirrors the pattern used
 * by {@code WorkspaceMcpServer}, {@code WorkspaceConnection}, and {@code WorkspaceAssetFile}: the agent itself is
 * workspace-agnostic; this row is the only place a workspace claims an agent. The unique constraint
