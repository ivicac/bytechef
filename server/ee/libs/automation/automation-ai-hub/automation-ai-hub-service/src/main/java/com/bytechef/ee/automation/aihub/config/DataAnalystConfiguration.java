...
import com.bytechef.ee.automation.aihub.tool.AggregateDataTableToolCallback;
import com.bytechef.ee.automation.aihub.tool.DataAnalystToolCallback;
...
public class DataAnalystConfiguration {
    ...
    ChatClient dataAnalystChatClient(
        ...
        ListDataTablesToolCallback listDataTables = new ListDataTablesToolCallback(dataTableService);
        ...
        return ChatClient.builder(chatModel)
            ...
            .defaultTools(spec -> spec.callbacks(listDataTables, queryDataTable, aggregateDataTable, openDataTableTab))
            .build();
    }
