 ...
 * only cares about deployments of one of them. The {@code environmentId} comes from {@link AiHubToolInvocationContext};
 * the result therefore scopes to the chat surface's currently selected environment.
 * </p>
 *
 * @version ee
 *
