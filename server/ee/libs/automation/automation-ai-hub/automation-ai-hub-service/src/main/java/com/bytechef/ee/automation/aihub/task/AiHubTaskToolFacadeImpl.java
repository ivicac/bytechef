...
import com.bytechef.ee.automation.aihub.task.repository.AiHubTaskComponentRepository;
import com.bytechef.ee.automation.aihub.task.repository.AiHubTaskToolRepository;
import com.bytechef.ee.platform.aihub.task.AiHubTaskComponent;
import com.bytechef.ee.platform.aihub.task.AiHubTaskTool;
...
import com.bytechef.ee.platform.aihub.toolsearch.ToolSearchCatalogFeeder.TaskToolReference;
...
public class AiHubTaskToolFacadeImpl implements AiHubTaskToolFacade {
     ...
     * </p>
     */
    private void scheduleRefreshForTask(long taskId) {
