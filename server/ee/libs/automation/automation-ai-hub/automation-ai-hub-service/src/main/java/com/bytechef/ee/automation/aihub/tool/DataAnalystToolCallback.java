 ...
 * {@link com.bytechef.ee.platform.aihub.tool.ResearchToolCallback} — no API exists to register a named subagent backed
 * by an externally-constructed {@link ChatClient}. The hand-rolled approach achieves the same architecture without
...
public class DataAnalystToolCallback implements ToolCallback {
    ...
    public String call(String toolInput, @Nullable ToolContext toolContext) {
        try {
            ...
            String result = CurrentAgentContext.callWith(Agent.DATA_ANALYST, parentAgent,
            ...
            if (result == null) {
                log.warn(
                    ...
                    LogSanitizer.sanitizeForLog(input.question()));
