...
import com.bytechef.ee.platform.aihub.tool.GenerateImageToolCallback;
import com.bytechef.ee.platform.aihub.tool.ImageGeneratorToolCallback;
...
public class ImageGeneratorConfiguration {
    ...
    ChatClient imageGeneratorChatClient(
        ...
        return ChatClient.builder(chatModel)
            ...
            .defaultTools(spec -> spec.callbacks(meteredGenerateImage, createBinaryAssetFile, openFileTab))
            .build();
    }
