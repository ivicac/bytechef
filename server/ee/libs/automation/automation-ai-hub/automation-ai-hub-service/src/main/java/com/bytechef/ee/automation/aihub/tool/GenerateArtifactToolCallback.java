 ...
 * {@link com.bytechef.ee.automation.aihub.artifact.ArtifactGenerator} beans; this callback dispatches by the
 * {@code format} field on the input JSON and rewraps the result into a tool-result envelope shaped to drive the
 * existing chat-chip + open-tab UX.
 *
 * <p>
