...
import com.bytechef.ee.automation.aihub.tool.CreateBinaryAssetFileToolCallback;
...
import com.bytechef.ee.platform.aihub.tool.CreateSlideDeckToolCallback;
import com.bytechef.ee.platform.aihub.tool.OpenFileTabToolCallback;
import com.bytechef.ee.platform.aihub.tool.SlideBuilderToolCallback;
import com.bytechef.ee.platform.aihub.usage.AiHubToolUsageContextResolver;
...
public class SlideBuilderConfiguration {
    ...
    ChatClient slideBuilderChatClient(
        ...
        return ChatClient.builder(chatModel)
            ...
            .defaultTools(
                spec -> spec.callbacks(meteredCreateSlideDeck, createBinaryAssetFile, getAssetFileContent, openFileTab))
            .build();
    }
