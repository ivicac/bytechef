 ...
 * {@link com.bytechef.ee.platform.aihub.agent.AgUiStreamBridge#onEvent} actually populates
 * {@link com.bytechef.ee.platform.aihub.agent.WorkflowChatJobRegistry} so cancel-turn can resolve back to the job
 * id.</li>
 *
 ...
 * execution. Verifies {@link com.bytechef.ee.platform.aihub.agent.WebhookResumeRegistry#consume} is atomically
