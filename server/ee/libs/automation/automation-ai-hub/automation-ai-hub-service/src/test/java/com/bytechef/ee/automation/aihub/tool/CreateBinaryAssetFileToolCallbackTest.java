...
class CreateBinaryAssetFileToolCallbackTest {
    ...
    void testCallSavesBinaryAndReturnsAssetMetadata() {
        ...
        ToolContext toolContext = new ToolContext(Map.of(
            AiHubToolInvocationContext.TOOL_CONTEXT_WORKSPACE_ID_KEY, 5L,
            AiHubToolInvocationContext.TOOL_CONTEXT_SOURCE_ORDINAL_KEY, (short) 1,
            AiHubToolInvocationContext.TOOL_CONTEXT_LAST_USER_PROMPT_KEY, "generate a logo"));
    ...
    void testCallSavesPdfBinaryAndReturnsAssetMetadata() {
        ...
        ToolContext toolContext = new ToolContext(Map.of(
            AiHubToolInvocationContext.TOOL_CONTEXT_WORKSPACE_ID_KEY, 5L,
            AiHubToolInvocationContext.TOOL_CONTEXT_SOURCE_ORDINAL_KEY, (short) 1,
            AiHubToolInvocationContext.TOOL_CONTEXT_LAST_USER_PROMPT_KEY, "save the report"));
    ...
    void testCallSavesGifBinaryAndReturnsAssetMetadata() {
        ...
        ToolContext toolContext = new ToolContext(Map.of(
            AiHubToolInvocationContext.TOOL_CONTEXT_WORKSPACE_ID_KEY, 5L,
            AiHubToolInvocationContext.TOOL_CONTEXT_SOURCE_ORDINAL_KEY, (short) 1,
            AiHubToolInvocationContext.TOOL_CONTEXT_LAST_USER_PROMPT_KEY, "attach a gif"));
    ...
    void testCallPrefersToolContextOverProvider() {
        ...
        ToolContext toolContext = new ToolContext(Map.of(
            AiHubToolInvocationContext.TOOL_CONTEXT_WORKSPACE_ID_KEY, 42L,
            AiHubToolInvocationContext.TOOL_CONTEXT_SOURCE_ORDINAL_KEY, (short) 3,
