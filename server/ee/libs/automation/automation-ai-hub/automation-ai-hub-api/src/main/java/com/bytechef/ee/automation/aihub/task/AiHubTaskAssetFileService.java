 ...
 * ({@link com.bytechef.ee.platform.aihub.task.AuthorshipAlreadyAssignedException}) when violated, which the caller can
 * act on.
 *
 * @version ee
 *
...
public interface AiHubTaskAssetFileService {
     ...
     * {@link com.bytechef.ee.platform.aihub.task.AuthorshipAlreadyAssignedException} when the asset_file already has a
