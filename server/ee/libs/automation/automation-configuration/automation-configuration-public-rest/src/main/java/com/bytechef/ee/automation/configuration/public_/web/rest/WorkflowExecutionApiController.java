...
public class WorkflowExecutionApiController implements WorkflowExecutionApi {
    ...
    public ResponseEntity<WorkflowExecutionModel> getWorkflowExecution(Long id) {
        return ResponseEntity.ok(toModel(projectWorkflowExecutionFacade.getWorkflowExecution(id)));
    }
    ...
    private WorkflowExecutionBasicModel toBasicModel(WorkflowExecutionDTO workflowExecutionDTO) {
        ...
        WorkflowExecutionBasicModel workflowExecutionBasicModel = new WorkflowExecutionBasicModel()
            ...
            .project(toProjectReferenceModel(workflowExecutionDTO))
            .projectDeployment(toProjectDeploymentReferenceModel(workflowExecutionDTO))
    ...
    private ProjectReferenceModel toProjectReferenceModel(WorkflowExecutionDTO workflowExecutionDTO) {
        if (workflowExecutionDTO.project() == null) {
            return null;
        }

        return new ProjectReferenceModel()
            .id(
                workflowExecutionDTO.project()
                    .getId())
            .name(
                workflowExecutionDTO.project()
                    .getName());
    ...
    private ProjectDeploymentReferenceModel toProjectDeploymentReferenceModel(
        WorkflowExecutionDTO workflowExecutionDTO) {

        if (workflowExecutionDTO.projectDeployment() == null) {
            return null;
        }

        return new ProjectDeploymentReferenceModel()
            .id(
                workflowExecutionDTO.projectDeployment()
                    .getId())
            .name(
                workflowExecutionDTO.projectDeployment()
                    .getName())
