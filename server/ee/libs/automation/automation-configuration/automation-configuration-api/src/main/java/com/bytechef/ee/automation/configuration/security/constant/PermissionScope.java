 ...
 * checked via {@code @PreAuthorize("hasPermission(#projectId, 'ProjectScope', 'SCOPE_NAME')")}. Built-in roles map to
 * scope sets in {@link BuiltInRoleScopes}; custom roles (EE) can define arbitrary scope combinations.
 *
 * <p>
