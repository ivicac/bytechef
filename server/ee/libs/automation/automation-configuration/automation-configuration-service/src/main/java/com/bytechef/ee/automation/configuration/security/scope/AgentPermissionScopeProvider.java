 ...
 * {@code PROJECT_DELETE}. An agent is a workflow-scale entity: it owns one generated workflow inside a project that can
 * hold other agents and workflows too. Deleting an agent is therefore closer to deleting a workflow than to deleting a
 * project.
 *
 * @version ee
 *
