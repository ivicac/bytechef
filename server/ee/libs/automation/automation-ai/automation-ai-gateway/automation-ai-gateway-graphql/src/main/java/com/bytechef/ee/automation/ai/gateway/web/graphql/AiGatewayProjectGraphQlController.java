...
class AiGatewayProjectGraphQlController {
    ...
    AiGatewayProjectGraphQlController(
    ...
    public AiGatewayProject createAiGatewayProject(@Argument CreateAiGatewayProjectInput input) {
        AiGatewayProject project = new AiGatewayProject(input.name(), input.slug());
        ...
        return workspaceAiGatewayProjectService.createInWorkspace(project, Long.parseLong(input.workspaceId()));
    }
