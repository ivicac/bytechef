...
/**
 * GraphQL query exposing the chat-capable AI provider catalog (USER-safe: no API keys) for the composer model picker.
 * Distinct from the ADMIN-only AI Providers REST surface.
 *
 * @version ee
 *
 * @author Ivica Cardic
