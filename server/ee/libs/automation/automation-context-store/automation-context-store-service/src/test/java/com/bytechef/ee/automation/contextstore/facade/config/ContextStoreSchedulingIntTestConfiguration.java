...
public class ContextStoreSchedulingIntTestConfiguration {
    ...
    ContextStoreService contextStoreService() {
        return mock(ContextStoreService.class);
    }
    ...
    WorkspaceContextStoreSourceFacadeImpl workspaceContextStoreSourceFacade(
        ...
        ConnectionService connectionService, ContextStoreSourceAuditPublisher contextStoreSourceAuditPublisher,
        ContextStoreService contextStoreService, ContextStoreSourceService contextStoreSourceService,
