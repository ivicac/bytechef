...
public class ContextStoreSchedulingIntTestConfiguration {
    ...
    WorkspaceContextStoreSourceFacadeImpl workspaceContextStoreSourceFacade(
        ...
        return new WorkspaceContextStoreSourceFacadeImpl(
            clickHouseTableProvisionerProvider, componentDefinitionService, contextStoreSourceService,
            principalJobFacade, projectDeploymentFacade, projectDeploymentService, projectDeploymentWorkflowService,
            projectService, projectWorkflowService, new SyncTaskExecutor(), workflowService,
            workspaceContextStoreService, workspaceContextStoreSourceService);
    }
