 ...
 *
 * <p>
 * Extends the CE-side {@link McpServerWorkspaceToolProvider} SPI so the CE McpServer configuration can discover the EE
 * implementation without taking a compile-time dependency on the EE module — the EE bean is wired in CE-only-compatible
 * shape via the CE-side interface.
 * </p>
 *
 * @author Ivica Cardic
 * @version ee
 */
public interface ContextStoreToolFacade extends McpServerWorkspaceToolProvider {
