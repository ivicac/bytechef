...
public class WorkflowAlertEventServiceImpl implements WorkflowAlertEventService {
    ...
    public WorkflowAlertEventServiceImpl(WorkflowAlertEventRepository workflowAlertEventRepository) {
    ...
    public List<WorkflowAlertEvent> getWorkflowAlertEvents(long workspaceId) {
        return workflowAlertEventRepository.findTop100ByWorkspaceIdOrderByCreatedDateDesc(workspaceId);
    }
}
