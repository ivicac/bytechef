package com.bytechef.ee.automation.api_platform.configuration.web.rest.model;
...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-09-02T15:08:08.578338+02:00[Europe/Zagreb]", comments = "Generator version: 7.5.0")
public class ApiCollectionModel {
  ...
  */
  ...
  @Schema(name = "projectInstanceId", description = "The id of an project instance the API collection is connected to.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, apiCollection.createdBy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, enabled, endpoints, id, name, lastModifiedBy, lastModifiedDate, projectId, projectInstanceId, projectVersion, tags, workspaceId, version);
  }
