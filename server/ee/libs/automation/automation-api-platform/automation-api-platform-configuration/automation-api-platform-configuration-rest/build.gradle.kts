...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    apiPackage.set("com.bytechef.ee.automation.api_platform.configuration.web.rest")
    configOptions.set(
        mapOf(
    ...
    modelPackage.set("com.bytechef.ee.automation.api_platform.configuration.web.rest.model")
