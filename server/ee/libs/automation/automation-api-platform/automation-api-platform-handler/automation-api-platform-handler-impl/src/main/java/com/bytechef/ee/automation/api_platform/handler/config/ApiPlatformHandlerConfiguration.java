...
package com.bytechef.ee.automation.api_platform.handler.config;
...
import com.bytechef.ee.automation.api_platform.handler.ApiPlatformHandlerExecutor;
import com.bytechef.ee.automation.api_platform.handler.executor.ApiPlatformHandlerExecutorImpl;
import com.bytechef.ee.automation.api_platform.handler.executor.ApiPlatformHandlerTriggerSyncExecutor;
 ...
 */
@Configuration
public class ApiPlatformHandlerConfiguration {

    @Bean
    ApiPlatformHandlerExecutor apiPlatformHandlerExecutor(
        ...
        return new ApiPlatformHandlerExecutorImpl(
            instanceAccessorRegistry,
            instanceJobFacade,
            new JobSyncExecutor(
