...
class EmbeddedKnowledgeBaseApiFacadeTest {
    ...
    void testNoOwnerListsEveryKnowledgeBaseInTheTenant() {
        ...
        verify(knowledgeBaseService).getKnowledgeBases(eq(0), eq(PlatformType.EMBEDDED), eq(Optional.empty()));
    }
    ...
    void testAnOwnerListsWhatThatAccountWouldSee() {
        ...
        verify(knowledgeBaseService)
            .getKnowledgeBases(eq(0), eq(PlatformType.EMBEDDED), eq(Optional.of(Owner.connectedUser(42L))));
    }
