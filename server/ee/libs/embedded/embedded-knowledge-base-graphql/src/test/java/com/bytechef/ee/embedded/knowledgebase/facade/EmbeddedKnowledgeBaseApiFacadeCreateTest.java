...
class EmbeddedKnowledgeBaseApiFacadeCreateTest {
    ...
    void testCreateGoesIntoTheEmbeddedPool() {
        embeddedKnowledgeBaseApiFacade.createKnowledgeBase(0L, "faq", "d", ChunkingSettings.none());
    ...
    void testCreateCarriesTheChunkingSettingsItWasGiven() {
        embeddedKnowledgeBaseApiFacade.createKnowledgeBase(0L, "faq", "d", new ChunkingSettings(512, 40, 64));
    ...
    void testCreateAppliesOnlyTheChunkingSettingsThatWereNamed() {
        embeddedKnowledgeBaseApiFacade.createKnowledgeBase(0L, "faq", "d", new ChunkingSettings(512, null, null));
