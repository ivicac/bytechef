...
import com.bytechef.ee.embedded.configuration.public_.web.rest.model.CodeWorkflowNotCopyableErrorModel;
...
public interface ConnectedUserProjectWorkflowApi {
     ...
     *         or The catalog workflow template is a code workflow template; it can only be referenced. (status code 409)
     */
    @Operation(
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "409", description = "The catalog workflow template is a code workflow template; it can only be referenced.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CodeWorkflowNotCopyableErrorModel.class))
            })
        },
        security = {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"reason\" : \"CODE_WORKFLOW_NOT_COPYABLE\" }";
    ...
    default ResponseEntity<List<ConnectedUserProjectWorkflowModel>> getFrontendProjectWorkflows(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"description\" : \"description\", \"definition\" : \"definition\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"enabled\" : true, \"label\" : \"label\", \"workflowUuid\" : \"workflowUuid\", \"workflowVersion\" : 0, \"kind\" : \"COPY\", \"catalogWorkflowUuid\" : \"catalogWorkflowUuid\", \"copiedFromWorkflowUuid\" : \"copiedFromWorkflowUuid\", \"dangling\" : true, \"components\" : [ { \"name\" : \"name\", \"title\" : \"title\", \"icon\" : \"icon\" }, { \"name\" : \"name\", \"title\" : \"title\", \"icon\" : \"icon\" } ], \"inputs\" : [ { \"name\" : \"name\", \"label\" : \"label\", \"type\" : \"type\", \"required\" : true }, { \"name\" : \"name\", \"label\" : \"label\", \"type\" : \"type\", \"required\" : true } ], \"inputValues\" : { \"key\" : \"\" }, \"attentionReason\" : \"attentionReason\" }, { \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"description\" : \"description\", \"definition\" : \"definition\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"enabled\" : true, \"label\" : \"label\", \"workflowUuid\" : \"workflowUuid\", \"workflowVersion\" : 0, \"kind\" : \"COPY\", \"catalogWorkflowUuid\" : \"catalogWorkflowUuid\", \"copiedFromWorkflowUuid\" : \"copiedFromWorkflowUuid\", \"dangling\" : true, \"components\" : [ { \"name\" : \"name\", \"title\" : \"title\", \"icon\" : \"icon\" }, { \"name\" : \"name\", \"title\" : \"title\", \"icon\" : \"icon\" } ], \"inputs\" : [ { \"name\" : \"name\", \"label\" : \"label\", \"type\" : \"type\", \"required\" : true }, { \"name\" : \"name\", \"label\" : \"label\", \"type\" : \"type\", \"required\" : true } ], \"inputValues\" : { \"key\" : \"\" }, \"attentionReason\" : \"attentionReason\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    @Operation(
        ...
        description = "Provision a reference to a catalog workflow template for the authenticated connected user.",
        tags = { "connected-user-project-workflow" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Successful operation."),
    ...
    /**
     * POST /{externalUserId}/automation/workflow-templates/{workflowUuid}/provision : Provision a reference to a catalog workflow template
    ...
    @Operation(
        ...
        summary = "Provision a reference to a catalog workflow template",
        description = "Explicitly provision a reference to a catalog workflow template ahead of first invocation.",
        tags = { "connected-user-project-workflow" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Successful operation."),
            @ApiResponse(responseCode = "400", description = "A requested connection is not one of the connected user's connections."),
