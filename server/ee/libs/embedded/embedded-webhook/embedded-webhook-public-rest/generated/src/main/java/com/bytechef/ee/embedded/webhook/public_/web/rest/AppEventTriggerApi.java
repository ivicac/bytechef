...
public interface AppEventTriggerApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"errors\" : [ { \"id\" : \"9366efb4-8fb1-4a28-bfb0-8d6f9cc6b5c5\", \"detail\" : \"detail\", \"problem_type\" : \"MISSING_REQUIRED_FIELD\", \"title\" : \"Property values were not valid\n\", \"code\" : \"MISSING_REQUIRED_FIELD\", \"status\" : \"400\", \"meta\" : { \"cause\" : \"{}\", \"origin\" : \"remote-provider\", \"application_name\" : \"MyCompany Production\" } }, { \"id\" : \"9366efb4-8fb1-4a28-bfb0-8d6f9cc6b5c5\", \"detail\" : \"detail\", \"problem_type\" : \"MISSING_REQUIRED_FIELD\", \"title\" : \"Property values were not valid\n\", \"code\" : \"MISSING_REQUIRED_FIELD\", \"status\" : \"400\", \"meta\" : { \"cause\" : \"{}\", \"origin\" : \"remote-provider\", \"application_name\" : \"MyCompany Production\" } } ] }";
     ...
     * Fires an App Event for the connected user identified by external user id, starting every one of their enabled workflows that has an App Event trigger. Returns no body; inspect the runs through the workflow executions endpoints.
     *
    ...
    @Operation(
        ...
        summary = "Trigger all subscribed workflows",
        description = "Fires an App Event for the connected user identified by external user id, starting every one of their enabled workflows that has an App Event trigger. Returns no body; inspect the runs through the workflow executions endpoints.",
        tags = { "app-event-trigger" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Successful operation."),
            @ApiResponse(responseCode = "400", description = "Bad request", content = {
