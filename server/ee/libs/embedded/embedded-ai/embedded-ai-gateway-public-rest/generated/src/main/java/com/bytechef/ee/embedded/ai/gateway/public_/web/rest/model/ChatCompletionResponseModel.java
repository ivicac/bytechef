...
/**
 * A chat completion response. The gateway&#39;s own routing metadata is NOT part of this body -- it is emitted as x-gateway-* response headers instead.
 */

@Schema(name = "ChatCompletionResponse", description = "A chat completion response. The gateway's own routing metadata is NOT part of this body -- it is emitted as x-gateway-* response headers instead.")
