...
public interface AiHubPersonalAgentService {
     ...
     * throws {@code com.bytechef.ee.platform.aihub.exception.ConflictException} so the caller can prompt the user (or
     * LLM) for a different name rather than silently overwriting.
     *
     * <p>
