...
public interface AiHubTaskService {
     ...
     * {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException} if the task does not belong to the requester
     * or does not belong to {@code requesterWorkspaceId}, and
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} when the task does not exist.
     */
     ...
     * Throws {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException} if the task does not belong to the
     * requester or does not belong to {@code requesterWorkspaceId}, and
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} when the task does not exist.
     */
    AiHubTask patch(
     ...
     * rows. Throws {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException} /
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} on the same ownership invariants as
     * {@link #patch}.
     * </p>
     *
     * <p>
     ...
     * {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException}/
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} on the same ownership invariants as
     * {@link #patch}.
     * </p>
     */
     ...
     * dismissed. Throws {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException}/
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} on the same ownership invariants as
     * {@link #patch}.
     * </p>
     *
     ...
     * {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException}/
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} on the same conditions as {@link #patch}.
     */
