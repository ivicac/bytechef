...
public interface AiHubTaskArtifactService {
     ...
     *
     * <p>
     * Throws {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException} on ownership / workspace mismatch and
     * {@link com.bytechef.ee.platform.aihub.exception.NotFoundException} when the task does not exist. Returns the
     * persisted (or pre-existing) artifact so callers can render it in the sidebar without a follow-up fetch.
     */
     ...
     * {@link com.bytechef.ee.platform.aihub.exception.ForbiddenException} on either mismatch and
