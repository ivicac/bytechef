...
package com.bytechef.ee.platform.aihub.progress;
 ...
 *
 * <p>
 * {@link com.bytechef.ee.platform.aihub.agent.AiHubSpringAIAgent} stashes its subscriber here before each subagent
 * tool-call executes. {@link ProgressReportingToolCallback} (and any other tool that wants to surface real-time
 * progress) can call {@link #emitProgress(String, String)} to emit a {@code subagent-progress} AG-UI
 * {@link CustomEvent} on that subscriber without having a direct reference to it.
 * </p>
 *
 * <p>
