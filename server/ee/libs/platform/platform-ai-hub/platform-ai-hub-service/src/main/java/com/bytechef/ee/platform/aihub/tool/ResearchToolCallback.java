 ...
 * Spring-managed {@link com.bytechef.ai.mcp.tool.platform.FirecrawlTools} bean. There is no API to register a named
...
public class ResearchToolCallback implements ToolCallback {
    ...
    public String call(String toolInput, @Nullable ToolContext toolContext) {
        try {
            ...
            String report = CurrentAgentContext.callWith(Agent.RESEARCH, parentAgent,
            ...
            if (report == null) {
                log.warn(
                    ...
                    LogSanitizer.sanitizeForLog(input.topic()));
