...
/**
 * Signaling-only Spring AI {@link ToolCallback} that instructs the AI Hub client to render a dropdown of EXISTING
    ...
    public String call(String toolInput, @Nullable ToolContext toolContext) {
        try {
            ...
            return jsonMapper.writeValueAsString(
                new SelectConnectionOutput("select-connection", componentName, componentLabel));
