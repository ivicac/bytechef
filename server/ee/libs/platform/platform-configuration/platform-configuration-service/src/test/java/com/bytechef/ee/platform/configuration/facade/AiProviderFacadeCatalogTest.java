...
/**
 * Pins the contract of {@link AiProviderFacadeImpl#getAiProviderCatalog} — the USER-safe read path that returns
 * chat-capable providers with their models and no API key.
 *
 * @version ee
 *
 * @author Ivica Cardic
