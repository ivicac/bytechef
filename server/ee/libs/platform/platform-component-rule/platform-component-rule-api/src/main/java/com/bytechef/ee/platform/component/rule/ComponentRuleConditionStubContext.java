...
public final class ComponentRuleConditionStubContext {
     ...
     * two name scalars, and {@code null} for {@code connectionId} — the same "no connection" value a real call without
     * one carries. A plain {@link HashMap} is used, not {@link Map#of}, because {@code connectionId} must be present
     * with a {@code null} value and {@code Map.of} rejects null values outright.
     */
