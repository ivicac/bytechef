...
/**
 * Translates {@code bytechef.connection.credential-store.hashicorp-vault.*} properties into {@code vault.*} properties
 * so Spring Vault's {@link org.springframework.vault.config.EnvironmentVaultConfiguration} wires up the
 * {@code VaultTemplate}.
 *
 * @version ee
 *
...
public class HashiCorpVaultCredentialStoreEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        copyIfPresent(environment, source,
            "bytechef.connection.credential-store.hashicorp-vault.uri", "vault.uri");
        copyIfPresent(environment, source,
            "bytechef.connection.credential-store.hashicorp-vault.authentication", "vault.authentication");
        copyIfPresent(environment, source,
            "bytechef.connection.credential-store.hashicorp-vault.token", "vault.token");
        copyIfPresent(environment, source,
