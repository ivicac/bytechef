...
public interface AiGatewayProviderRepository extends ListCrudRepository<AiGatewayProvider, Long> {
    ...
    /**
     * Returns all providers bound to the given connected user. Used both to disable a connected user's credentials when
     * they are revoked or deauthorized, and to verify a provider belongs to the connected user before an operation on
     * it (e.g. {@code ConnectedUserAiGatewayFacadeImpl#deleteProvider}) is allowed to proceed.
     */
