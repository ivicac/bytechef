...
public interface AiGatewaySpendService {
    ...
    /**
     * Returns the spend summaries belonging to no workspace -- the embedded connected-user rollup rows -- whose period
     * starts inside the range.
     */
    List<AiGatewaySpendSummary> getSpendSummariesWithoutWorkspace(Instant start, Instant end);
