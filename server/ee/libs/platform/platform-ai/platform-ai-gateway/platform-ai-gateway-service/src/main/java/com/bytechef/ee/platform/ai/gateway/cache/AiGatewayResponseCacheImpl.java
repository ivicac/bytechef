...
public class AiGatewayResponseCacheImpl implements AiGatewayResponseCache {

    private static final Logger log = LoggerFactory.getLogger(AiGatewayResponseCacheImpl.class);

    private final ObjectMapper objectMapper;

    public AiGatewayResponseCacheImpl(ObjectMapper objectMapper) {
