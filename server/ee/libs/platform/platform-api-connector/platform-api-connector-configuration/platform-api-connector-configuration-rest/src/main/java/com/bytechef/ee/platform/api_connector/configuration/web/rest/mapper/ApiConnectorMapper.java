...
package com.bytechef.ee.platform.api_connector.configuration.web.rest.mapper;

import com.bytechef.ee.platform.api_connector.configuration.domain.ApiConnector;
import com.bytechef.ee.platform.api_connector.configuration.dto.ApiConnectorDTO;
import com.bytechef.ee.platform.api_connector.configuration.web.rest.mapper.config.PlatformApiConnectorMapperSpringConfig;
import com.bytechef.ee.platform.api_connector.configuration.web.rest.model.ApiConnectorModel;
...
public class ApiConnectorMapper {
    ...
    @Mapper(config = PlatformApiConnectorMapperSpringConfig.class)
