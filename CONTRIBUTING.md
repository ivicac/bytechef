...
8. Add your changes. If you are adding a component, you can do that [Manually](https://docs.bytechef.io/developer-guide/build-component) or with a [Connector Generator](https://docs.bytechef.io/developer-guide/generate-component).
